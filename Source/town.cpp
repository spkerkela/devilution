...
//----- (0045E226) --------------------------------------------------------
void __fastcall town_draw_clipped_e_flag(void *buffer, int x, int y, int sx,
                                         int sy) {
  int v5;        // ebx
  char *v6;      // esi
  signed int v7; // edi
...
//----- (0045E2A5) --------------------------------------------------------
void __fastcall town_draw_clipped_town(void *unused, int x, int y, int sx,
                                       int sy, int some_flag) {
  unsigned int v6; // edx
  int v7;          // edi
  char v8;         // al
  char v9;         // al
  ...
  if (v8) {
    ...
    if (v9 == pcursitem)
      CelDrawHdrClrHL(181, v11, sy, (char *)item[v10]._iAnimData,
                      item[v10]._iAnimFrame, item[v10]._iAnimWidth, 0, 8);
    Cel2DrawHdrOnly(v11, sy, (char *)item[v10]._iAnimData,
                    item[v10]._iAnimFrame, item[v10]._iAnimWidth, 0, 8);
  }
  if (dFlags[0][v7] & 0x10) {
    ...
    if (v12 == pcursmonst)
      CelDrawHdrClrHL(166, v13, sy, (char *)towner[v12]._tAnimData,
                      towner[v12]._tAnimFrame, towner[v12]._tAnimWidth, 0, 8);
    Cel2DrawHdrOnly(v13, sy, (char *)towner[v12]._tAnimData,
                    towner[v12]._tAnimFrame, towner[v12]._tAnimWidth, 0, 8);
  }
  v14 = dMonster[0][v7];
  if (v14 > 0) {
    ...
    if (v15 == pcursmonst)
      CelDrawHdrClrHL(166, v17, sy, (char *)towner[v16]._tAnimData,
                      towner[v16]._tAnimFrame, towner[v16]._tAnimWidth, 0, 8);
    Cel2DrawHdrOnly(v17, sy, (char *)towner[v16]._tAnimData,
                    towner[v16]._tAnimFrame, towner[v16]._tAnimWidth, 0, 8);
  }
  if (dFlags[0][v7] & 0x20) {
    v18 = -1 -
          dPlayer[x][y - 1]; // -1 - *((_BYTE *)&themeLoc[49].height + v7 + 3);
    v19 = v18;
    v20 = sy + plr[v19]._pyoff;
    v21 = sx + plr[v19]._pxoff - plr[v19]._pAnimWidth2;
    if (v18 == pcursplr)
      Cl2DecodeClrHL(165, v21, v20, (char *)plr[v19]._pAnimData,
                     plr[v19]._pAnimFrame, plr[v19]._pAnimWidth, 0, 8);
    Cl2DecodeFrm4(v21, v20, (char *)plr[v19]._pAnimData, plr[v19]._pAnimFrame,
                  plr[v19]._pAnimWidth, 0, 8);
  ...
  if (v22 > 0) {
    ...
    if (v23 == pcursplr)
      Cl2DecodeClrHL(165, v26, v25, (char *)plr[v24]._pAnimData,
                     plr[v24]._pAnimFrame, plr[v24]._pAnimWidth, 0, 8);
    Cl2DecodeFrm4(v26, v25, (char *)plr[v24]._pAnimData, plr[v24]._pAnimFrame,
                  plr[v24]._pAnimWidth, 0, 8);
...
//----- (0045E5B0) --------------------------------------------------------
void __fastcall town_draw_lower(int x, int y, int sx, int sy, int a5,
                                int some_flag) {
  int v6;         // ebx
  int *v7;        // edi
  char *v8;       // esi
  ...
  if (a5 - some_flag > 0) {
    ...
    a1a = v10;
    do {
      if (y >= 0 && y < 112 && v12 >= 0 && v12 < 12544 &&
          (level_cel_block = dPiece[0][v12 + y]) != 0) {
        v13 = (char *)gpBuffer + *v11 + sx;
        v14 = (char *)dpiece_defs_map_1 +
              32 * gendung_get_dpiece_num_from_coord(xa, ya);
        v26 = 0;
        do {
  ...
  if (some_flag) {
    if (y >= 0 && y < 112 && xa >= 0 && xa < 112 &&
        (level_cel_block = dPiece[0][y + 112 * xa]) != 0) {
      v18 = &screen_y_times_768[v6];
      v19 = (char *)gpBuffer + *v18 + sx;
      v20 = (char *)dpiece_defs_map_1 +
            32 * gendung_get_dpiece_num_from_coord(xa, ya);
      v27 = 0;
      do {
...
//----- (0045E898) --------------------------------------------------------
void __fastcall town_draw_clipped_e_flag_2(void *buffer, int x, int y, int a4,
                                           int a5, int sx, int sy) {
  int v7;    // ebx
  char *v8;  // edi
  short *v9; // esi
  int v10;   // eax
  ...
  if (a4)
    ...
    v8 = (char *)buffer;
  a4a = 0;
  v9 = &dpiece_defs_map_1[0][0]
                         [16 * gendung_get_dpiece_num_from_coord(x, y) + 3];
  do {
    if (v7 <= a4a) {
...
//----- (0045E939) --------------------------------------------------------
void __fastcall town_draw_clipped_town_2(int x, int y, int a3, int a4, int a5,
                                         int sx, int sy, int some_flag) {
  unsigned int v8; // edx
  int v9;          // ebx
  char v10;        // al
  char v11;        // al
  ...
  if (v10) {
    ...
    if (v11 == pcursitem)
      CelDrawHdrClrHL(181, v13, sy, (char *)item[v12]._iAnimData,
                      item[v12]._iAnimFrame, item[v12]._iAnimWidth, a5, 8);
    Cel2DrawHdrOnly(v13, sy, (char *)item[v12]._iAnimData,
                    item[v12]._iAnimFrame, item[v12]._iAnimWidth, a5, 8);
  }
  if (dFlags[0][v9] & 0x10) {
    ...
    if (v14 == pcursmonst)
      CelDrawHdrClrHL(166, v15, sy, (char *)towner[v14]._tAnimData,
                      towner[v14]._tAnimFrame, towner[v14]._tAnimWidth, a5, 8);
    Cel2DrawHdrOnly(v15, sy, (char *)towner[v14]._tAnimData,
                    towner[v14]._tAnimFrame, towner[v14]._tAnimWidth, a5, 8);
  }
  v16 = dMonster[0][v9];
  if (v16 > 0) {
    ...
    if (v17 == pcursmonst)
      CelDrawHdrClrHL(166, v19, sy, (char *)towner[v18]._tAnimData,
                      towner[v18]._tAnimFrame, towner[v18]._tAnimWidth, a5, 8);
    Cel2DrawHdrOnly(v19, sy, (char *)towner[v18]._tAnimData,
                    towner[v18]._tAnimFrame, towner[v18]._tAnimWidth, a5, 8);
  }
  if (dFlags[0][v9] & 0x20) {
    v20 = -1 -
          dPlayer[x][y - 1]; // -1 - *((_BYTE *)&themeLoc[49].height + v9 + 3);
    v21 = v20;
    v22 = sy + plr[v21]._pyoff;
    v23 = sx + plr[v21]._pxoff - plr[v21]._pAnimWidth2;
    if (v20 == pcursplr)
      Cl2DecodeClrHL(165, v23, v22, (char *)plr[v21]._pAnimData,
                     plr[v21]._pAnimFrame, plr[v21]._pAnimWidth, a5, 8);
    Cl2DecodeFrm4(v23, v22, (char *)plr[v21]._pAnimData, plr[v21]._pAnimFrame,
                  plr[v21]._pAnimWidth, a5, 8);
    if (some_flag && plr[v21]._peflag)
      town_draw_clipped_e_flag_2((void *)(v29 - 64), xa - 1, a3 + 1, a4, a5,
                                 sx - 64, sy);
    v9 = v31;
  }
  if (dFlags[0][v9] & 4)
  ...
  if (v24 > 0) {
    ...
    if (v25 == pcursplr)
      Cl2DecodeClrHL(165, v28, v27, (char *)plr[v26]._pAnimData,
                     plr[v26]._pAnimFrame, plr[v26]._pAnimWidth, a5, 8);
    Cl2DecodeFrm4(v28, v27, (char *)plr[v26]._pAnimData, plr[v26]._pAnimFrame,
                  plr[v26]._pAnimWidth, a5, 8);
...
//----- (0045EC49) --------------------------------------------------------
void __fastcall town_draw_lower_2(int x, int y, int sx, int sy, int a5, int a6,
                                  int some_flag) {
  int v7;         // esi
  int v8;         // ebx
  int *v9;        // edi
  ...
  if (some_flag) {
    if (y < 0 || y >= 112 || x < 0 || x >= 112) {
      ...
      if (level_cel_block) {
        ...
        sxa = 0;
        v10 = &dpiece_defs_map_1[0][0]
                                [16 * gendung_get_dpiece_num_from_coord(x, y) +
                                 3];
        v23 = v10;
        do {
          if (a6 <= sxa) {
        ...
        if (2 * a6 + 2 < 8)
          town_draw_clipped_town_2((int)gpBuffer + *v9 + v7, xa, ya, a6,
                                   2 * a6 + 2, v7, sy, 0);
        goto LABEL_16;
      }
    }
...
LABEL_18:
  ...
  if (a5 - some_flag > 0) {
    ...
    v24 = v12;
    do {
      if (ya >= 0 && ya < 112 && v14 >= 0 && v14 < 12544 &&
          (level_cel_block = dPiece[0][v14 + ya]) != 0) {
        a1a = (char *)gpBuffer + *v13 + v11 - 24576;
        sxb = 0;
        v15 =
            &dpiece_defs_map_1[0][0]
                              [16 * gendung_get_dpiece_num_from_coord(xa, ya) +
                               3];
        do {
          if (a6 <= sxb) {
        ...
        v18 = 2 * a6 + 2;
        if (v18 < 8)
          town_draw_clipped_town_2((int)gpBuffer + *v13 - 12288 * v18 + v11, xa,
                                   ya, a6, 2 * a6 + 2, v11, sy, 1);
        v14 = a5a;
      } else {
  ...
  if (some_flag) {
    if (ya >= 0 && ya < 112 && xa >= 0 && xa < 112 &&
        (level_cel_block = dPiece[0][ya + 112 * xa]) != 0) {
      v20 = &screen_y_times_768[v8];
      a1b = (char *)gpBuffer + *v20 + v11 - 24576;
      sxc = 0;
      v21 = &dpiece_defs_map_1[0][0]
                              [16 * gendung_get_dpiece_num_from_coord(xa, ya) +
                               2];
      do {
        if (a6 <= sxc) {
      ...
      if (2 * a6 + 2 < 8)
        town_draw_clipped_town_2((int)gpBuffer + *v20 + v11, xa, ya, a6,
                                 2 * a6 + 2, v11, sy, 0);
    } else {
...
//----- (0045EF8A) --------------------------------------------------------
void __fastcall town_draw_e_flag(void *buffer, int x, int y, int a4, int dir,
                                 int sx, int sy) {
  int v7;        // ebx
  char *v8;      // esi
  int v9;        // edi
...
//----- (0045F013) --------------------------------------------------------
void __fastcall town_draw_town_all(void *buffer, int x, int y, int a4, int dir,
                                   int sx, int sy, int some_flag) {
  // int v9; // ebx
  int id; // esi
  int yy; // ebx
  ...
  if (dItem[x][y]) {
    ...
    if (id == pcursitem)
      CelDecodeClr(181, xx, sy, (char *)item[id]._iAnimData,
                   item[id]._iAnimFrame, item[id]._iAnimWidth, 0, dir);
    CelDrawHdrOnly(xx, sy, (char *)item[id]._iAnimData, item[id]._iAnimFrame,
                   item[id]._iAnimWidth, 0, dir);
  }
  if (dFlags[x][y] & 0x10) {
    id = -1 - dMonster[x][y - 1]; // -1 - *(&dword_52D204 + v9); /* check */
    xx = sx - towner[id]._tAnimWidth2;
    if (id == pcursmonst)
      CelDecodeClr(166, xx, sy, (char *)towner[id]._tAnimData,
                   towner[id]._tAnimFrame, towner[id]._tAnimWidth, 0, dir);
    CelDrawHdrOnly(xx, sy, (char *)towner[id]._tAnimData,
                   towner[id]._tAnimFrame, towner[id]._tAnimWidth, 0, dir);
  }
  if (dMonster[x][y] > 0) {
    id = dMonster[x][y] - 1;
  ...
  if (dFlags[x][y] & 0x20) {
    ...
    if (id == pcursplr)
      Cl2DecodeFrm2(165, xx, yy, (char *)plr[id]._pAnimData,
                    plr[id]._pAnimFrame, plr[id]._pAnimWidth, 0, dir);
    Cl2DecodeFrm1(xx, yy, (char *)plr[id]._pAnimData, plr[id]._pAnimFrame,
                  plr[id]._pAnimWidth, 0, dir);
...
//----- (0045F323) --------------------------------------------------------
void __fastcall town_draw_upper(int x, int y, int sx, int sy, int a5, int a6,
                                int some_flag) {
  signed int v7;  // ebx
  int v8;         // esi
  int v9;         // eax
  ...
  if (some_flag) {
    if (y < 0 || y >= 112 || x < 0 || x >= 112) {
      ...
      v11 = sy;
      if (!v10) {
        a1 = (int *)&gpBuffer->row_unused_1[0]
                 .col_unused_1[sx + 32 + screen_y_times_768[sy]];
        sxa = 0;
        v12 = &dpiece_defs_map_1[0][0]
                                [16 * gendung_get_dpiece_num_from_coord(x, y) +
                                 1];
        do {
          if (a6 >= sxa) {
        ...
        town_draw_town_all((char *)gpBuffer + v8 + screen_y_times_768[sy], xa,
                           ya, a6, dir, v8, sy, 0);
        v7 = ya;
        goto LABEL_17;
      }
    ...
    do {
      if (v7 < 0 || v7 >= 112 || v15 < 0 || v15 >= 12544) {
        ...
        if (!v10) {
          ...
          town_draw_town_all((char *)gpBuffer + v14 + screen_y_times_768[sy],
                             xa, ya, a6, dir, v14, sy, 1);
          v15 = a5a;
          v7 = ya;
          goto LABEL_36;
        }
  ...
  if (some_flag) {
    if (v7 < 0 || v7 >= 112 || xa < 0 || xa >= 112) {
      ...
      if (!v10) {
        ...
        town_draw_town_all((char *)gpBuffer + v14 + screen_y_times_768[sy], xa,
                           ya, a6, dir, v14, sy, 0);
        return;
      }
    }
  ...
  do {
    ...
    do {
      ...
      v3 = (char *)dpiece_defs_map_1 +
           32 * gendung_get_dpiece_num_from_coord(v1, y);
      if (v2) {
        v4 = 32 * v2 + *(_DWORD *)&dpiece_defs[0].blocks - 32;
        v5 = 0;
        do {
          *(_WORD *)&v3[2 * v5] =
              *(_WORD *)(v4 + 2 * ((v5 & 1) - (v5 & 0xE)) + 28);
          ++v5;
        } while (v5 < 16);
      } else {
        memset(v3, 0, 0x20u);
...
//----- (0045FCBF) --------------------------------------------------------
void __fastcall T_FillSector(unsigned char *P3Tiles, unsigned char *pSector,
                             int xi, int yi, int w,
                             int h) /* check 7 params: int AddSec */
{
  int v7;             // ebx
  int v8;             // edx
  int v9;             // edi
