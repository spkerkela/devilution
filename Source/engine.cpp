  ...
  if (gpBuffer)
  {
    if (pCelBuff)
      CelDrawDatOnly((char *)gpBuffer + screen_y_times_768[screen_y] + screen_x,
                     ...
                     *((_DWORD *)pCelBuff + frame + 1) -
                         *((_DWORD *)pCelBuff + frame),
                     frame_width);
  }
}
  ...
  if (gpBuffer)
  {
    if (pCelBuff)
    {
      ...
      if (*(_WORD *)&pCelBuff[v7 + always_0])
      {
        ...
        CelDrawDatOnly((char *)gpBuffer +
                           screen_y_times_768[v12 - 16 * always_0] + v11,
                       &v8[v9], v10, frame_width);
      }
    }
  }
}
  ...
  if (gpBuffer)
  {
    ...
    if (pCelBuff)
    {
      ...
      if (v12)
      {
        ...
        cel_bufa =
            (char *)gpBuffer + screen_y_times_768[screen_y - 16 * v10] + v21;
        v14 = -(light4flag != 0);
    ...
    if (pCelBuff)
    {
      ...
      if (*(_WORD *)&pCelBuff[v7 + a6])
      {
        if (direction != 8 && *(_WORD *)&v8[direction])
          ...
          v10 = *(_DWORD *)&pCelBuff[4 * frame + 4] - v7 - v9;
        Cel2DecDatOnly((char *)gpBuffer + screen_y_times_768[v12 - 16 * a6] +
                           v11,
                       &v8[v9], v10, frame_width);
      }
    }
  ...
  if (gpBuffer)
  {
    ...
    if (pCelBuff)
    {
      ...
      if (v11)
      {
        ...
        always_0a = (char *)gpBuffer +
                    screen_y_times_768[screen_y - 16 * always_0] + v22;
        v13 = -(light4flag != 0);
...
//----- (00417577) --------------------------------------------------------
void __cdecl mem_init_mutex() { InitializeCriticalSection(&sgMemCrit); }

//----- (00417583) --------------------------------------------------------
void __cdecl mem_atexit_mutex() { atexit(mem_free_mutex); }
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (*(_WORD *)(v10 + dir1))
        {
          ...
          Cl2DecDatFrm1((char *)gpBuffer + screen_y_times_768[y - 16 * dir1] +
                            x,
                        (char *)(*(unsigned short *)(v10 + dir1) + v10),
                        v11 - *(unsigned short *)(v10 + dir1), width);
        }
      }
    }
  }
...
//----- (004177BF) --------------------------------------------------------
void __fastcall Cl2DecDatFrm1(char *buffer, char *frame_content, int a3,
                              int width) /* fix */
{
  char *v4; // esi
  char *v5; // edi
      ...
      if (nCel > 0)
      {
        ...
        if (*(_WORD *)&pCelBuff[v8 + a7])
        {
          ...
          Cl2DecDatFrm2(
              ...
              v10 - *(unsigned short *)&pCelBuff[v8 + a7], frame_width, colour);
        }
      }
    }
  }
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (v11)
        {
          ...
          if (a8 >= 4)
            v16 = v16 + (a8 << 8) - 256;
          Cl2DecDatLightTbl1((char *)gpBuffer +
                                 screen_y_times_768[screen_y - 16 * a6] +
                                 screen_x,
                             v13, v14, frame_width, &pLightTbl[v16]);
        }
      }
    }
  }
...
//----- (00417A44) --------------------------------------------------------
void __fastcall Cl2DecDatLightTbl1(char *a1, char *a2, int a3, int a4,
                                   char *unused_lindex) /* check 5th arg */
{
  char *v5; // esi
  char *v6; // edi
  int v7;   // ebx
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (v11)
        {
          ...
          if (light_table_index)
            Cl2DecDatLightTbl1(v15, v14, v13, frame_width,
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (*(_WORD *)(v10 + a6))
        {
          ...
          Cl2DecDatFrm4((char *)gpBuffer + screen_y_times_768[v7 - 16 * a6] +
                            v12,
                        (char *)(*(unsigned short *)(v10 + a6) + v10),
                        v11 - *(unsigned short *)(v10 + a6), frame_width);
        }
      }
    }
  }
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (*(_WORD *)&pCelBuff[v8 + a7])
        {
          ...
          screen_buf_end -= 768;
          Cl2DecDatClrHL((char *)gpBuffer +
                             screen_y_times_768[screen_y - 16 * a7] + v12,
                         &v9[v10], v11 - v10, frame_width, a5);
          screen_buf_end += 768;
        }
      }
    }
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (v11)
        {
          ...
          if (a8 >= 4)
            v16 = v16 + (a8 << 8) - 256;
          Cl2DecDatLightTbl2((char *)gpBuffer +
                                 screen_y_times_768[screen_y - 16 * a6] +
                                 screen_x,
                             v13, v14, frame_width, &pLightTbl[v16]);
        }
...
//----- (00417EBB) --------------------------------------------------------
void __fastcall Cl2DecDatLightTbl2(char *dst_buf, char *a2, int a3,
                                   int frame_width,
                                   char *a5) /* check 5th arg */
{
  char *v5; // esi
  char *v6; // edi
  int v7;   // ebx
    ...
    if (pCelBuff)
    {
      if (nCel > 0)
      {
        ...
        if (v11)
        {
          ...
          v15 = (char *)gpBuffer + screen_y_times_768[v7 - 16 * a6] + screen_x;
          if (light_table_index)
            Cl2DecDatLightTbl2(v15, v14, v13, frame_width,
                               &pLightTbl[256 * light_table_index]);
          else
