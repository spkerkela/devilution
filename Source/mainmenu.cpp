...
struct mainmenu_cpp_init {
  mainmenu_cpp_init() { mainmenu_cpp_init_value = mainmenu_inf; }
} _mainmenu_cpp_init;
...
//----- (00427E62) --------------------------------------------------------
int __stdcall mainmenu_select_hero_dialog(int u1, int u2, int u3, int u4,
                                          int mode, char *cname, int clen,
                                          char *cdesc, int cdlen,
                                          int *multi) /* fix args */
{
  int v10; // eax
  ...
  a5 = 0;
  if (gbMaxPlayers == 1) {
    if (!UiSelHeroSingDialog(pfile_ui_set_hero_infos, pfile_ui_save_create,
                             pfile_delete_save, pfile_ui_set_class_stats, &a5,
                             chr_name_str, &gnDifficulty))
    ...
    dword_5256E8 = 0;
                                  ...
                                  pfile_delete_save, pfile_ui_set_class_stats,
                                  &a5, &a6, chr_name_str)) {
