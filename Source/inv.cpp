...
void __cdecl DrawInv() {
  ...
  if (plr[myplr].InvBody[5]._itype != -1) {
    ...
    if (pcursinvitem == 5) {
      ...
      if (!plr[v28].InvBody[5]._iStatFlag)
        v31 = -27;
      CelDecodeClr(v31, v30 != 28 ? 633 : 645, screen_yd, (char *)pCursCels,
                   v29, v30, 0, 8);
      v27 = myplr;
    }
    ...
    if (plr[v27].InvBody[5]._iStatFlag)
      ...
      CelDrawHdrLightRed(screen_x, screen_yd, (char *)pCursCels, v29, v30, 0, 8,
                         1);
  }
  ...
  do {
    if (plr[myplr].InvGrid[v37])
      InvDrawSlotBack(InvRect[v37 + 25].X + 64, InvRect[v37 + 25].Y + 159, 28,
                      28);
    ++v37;
  } while (v37 < 40);
  v38 = 0;
    ...
    if (v40 > 0) {
      ...
      if (pcursinvitem == v41 + 7) {
        ...
        if (!*(int *)((char *)&plr[0].InvList[0]._iStatFlag + v43))
          v45 = -27;
        CelDecodeClr(v45, InvRect[v38 + 25].X + 64, InvRect[v38 + 25].Y + 159,
                     (char *)pCursCels, v44, screen_ye, 0, 8);
      }
      ...
      if (plr[myplr].InvList[v42]._iStatFlag)
        ...
        CelDrawHdrLightRed(v46, v47, (char *)pCursCels, v44, screen_ye, 0, 8,
                           1);
    }
    ++v38;
  } while (v38 < 40);
  ...
  if (!talkflag) {
    ...
    do {
      if (*(int *)((char *)&plr[myplr].SpdList[0]._itype + v0) != -1) {
        v1 = v11;
        InvDrawSlotBack(InvRect[v11 + 65].X + 64, InvRect[v11 + 65].Y + 159, 28,
                        28);
        v2 = myplr;
        v3 = v0 + 21720 * myplr;
        ...
        if (pcursinvitem == v11 + 47) {
          ...
          if (!*(int *)((char *)&plr[0].SpdList[0]._iStatFlag + v3))
            v5 = -27;
          CelDecodeClr(v5, InvRect[v1 + 65].X + 64, InvRect[v1 + 65].Y + 159,
                       (char *)pCursCels, v4, frame_width, 0, 8);
          v2 = myplr;
        }
        v0 = v13;
        ...
        v8 = InvRect[v1 + 65].X;
        if (v7)
          CelDrawHdrLightRed(v8 + 64, v6, (char *)pCursCels, v4, frame_width, 0,
                             8, 1);
        else
          CelDrawHdrOnly(v8 + 64, v6, (char *)pCursCels, v4, frame_width, 0, 8);
        v9 = v13 + 21720 * myplr;
        if (AllItemsList[*(int *)((char *)&plr[0].SpdList[0].IDidx + v9)]
                .iUsable &&
            *(int *)((char *)&plr[0].SpdList[0]._iStatFlag + v9) &&
            *(int *)((char *)&plr[0].SpdList[0]._itype + v9) != 11) {
          v10 = fontframe[fontidx[(unsigned char)(v11 + 49)]];
          CPrintString(screen_y_times_768[InvRect[v1 + 65].Y + 159] -
                           fontkern[v10] + InvRect[v1 + 65].X + 92,
                       v10, 0);
        }
      }
      ++v11;
...
int __fastcall AutoPlace(int pnum, int ii, int sx, int sy, int saveflag) {
  ...
  LABEL_16:
    if (saveflag) {
      v11 = pnum;
      qmemcpy(&plr[pnum].InvList[plr[pnum]._pNumInv], &plr[pnum].HoldItem,
...
//----- (0041C373) --------------------------------------------------------
int __fastcall SpecialAutoPlace(int pnum, int ii, int sx, int sy,
                                int saveflag) {
  __int64 v5;     // rax
  int v6;         // ebx
  signed int v7;  // edx
  ...
  LABEL_25:
    if (saveflag) {
      v13 = p;
      qmemcpy(&plr[p].InvList[plr[p]._pNumInv], &plr[p].HoldItem,
              sizeof(plr[p].InvList[plr[p]._pNumInv]));
      ++plr[v13]._pNumInv;
      v14 = v7;
      if (v7 < 0)
        v14 = 0;
...
LABEL_18:
  ...
  LABEL_50:
    ...
    if (plr[v3].HoldItem._itype == ITYPE_GOLD) {
      ...
      if ((char)v13 <= 0) {
        v13 = -v13;
      } else if (*(int *)((char *)&plr[0].InvBody[v13 + 6]._itype +
                          v3 * 21720) == ITYPE_GOLD) {
        goto LABEL_93;
      }
      v66 = v13;
    LABEL_93:
      ...
      LABEL_147:
        if (plr[v3].InvBody[5]._itype == ITYPE_NONE) {
          NetSendCmdChItem(0, 4u);
          qmemcpy(&plr[v3].InvBody[4], &plr[v3].HoldItem,
                  sizeof(plr[v3].InvBody[4]));
        } else {
        LABEL_149:
          NetSendCmdChItem(0, 4u);
          if (plr[v3].InvBody[4]._itype == ITYPE_NONE)
      ...
      case ILOC_UNEQUIPABLE:
        ...
        if (v35 == 11) {
          if (!v66) {
            v36 = &plr[0].InvGrid[10 * ((v68 - 25) / 10) + v3 * 21720 +
                                  (v68 - 25) % 10];
            if (*v36 <= 0) {
          ...
          qmemcpy((char *)&plr[0].InvList[plr[v3]._pNumInv++] + v3 * 21720,
                  &plr[v3].HoldItem, 0x170u);
          v66 = plr[v3]._pNumInv;
        LABEL_191:
          v48 = v67;
        ...
        if (v35 == 11)
          plr[v3]._pGold += plr[v3].HoldItem._ivalue;
        cursor_ida =
            SwapItem((ItemStruct *)((char *)&plr[0].InvList[v44] + v3 * 21720),
                     &plr[v3].HoldItem);
        if (plr[v3].HoldItem._itype == ITYPE_GOLD)
      ...
      case ILOC_BELT:
        ...
        if (plr[v3].HoldItem._itype != ITYPE_GOLD) {
          if (*(int *)((char *)&plr[0].SpdList[0]._itype + v53) == ITYPE_NONE) {
            ...
            cursor_ida = SwapItem((ItemStruct *)((char *)plr[0].SpdList + v53),
                                  &plr[v3].HoldItem);
            if (plr[v3].HoldItem._itype == ITYPE_GOLD)
        ...
        if (v54 != -1) {
          if (v54 == 11) {
            ...
            *(int *)((char *)&plr[0].SpdList[0]._iCurs + v53) = 6;
            ...
            plr[v3]._pGold += plr[v3].HoldItem._ivalue;
            v59 = SwapItem((ItemStruct *)((char *)plr[0].SpdList + v53),
                           &plr[v3].HoldItem);
          }
          cursor_ida = v59;
          goto LABEL_225;
...
LABEL_81:
  if (!v12)
    return;
  if (v69 == ILOC_UNEQUIPABLE || v69 == ILOC_BELT ||
      plr[v3].HoldItem._iStatFlag)
    goto LABEL_92;
  v19 = plr[v3]._pClass;
  if (!v19) {
    v20 = PS_WARR13;
...
void __fastcall CheckInvCut(int pnum, int mx, int my) {
  ...
  LABEL_26:
    ...
    if (v5 >= 25 && v5 <= 64) {
      v8 = plr[v3]
               .InvGrid[v5 - 25]; // *((_BYTE *)&plr[0].InvList[39]._iVAdd2 + v5
                                  // + v3 * 21720 + 3); /* find right address */
      if (v8) {
        v9 = v8;
        if (v8 <= 0)
          v9 = -v8;
        ...
        v13 = v9 - 1;
        qmemcpy(&plr[v3].HoldItem, (char *)&plr[0].InvList[v13] + v3 * 21720,
                sizeof(plr[v3].HoldItem));
        v14 = --plr[v3]._pNumInv;
        if (v14 > 0 && v14 != v13) {
          qmemcpy((char *)&plr[0].InvList[v13] + v3 * 21720,
                  (char *)&plr[0].InvList[v14] + v3 * 21720, 0x170u);
          v15 = 0;
          do {
    ...
    if (v5 >= 65) {
      ...
      if (*(int *)((char *)&plr[0].SpdList[0]._itype + v17) != -1) {
        qmemcpy(&plr[v3].HoldItem, (char *)plr[0].SpdList + v17,
                sizeof(plr[v3].HoldItem));
...
void __fastcall RemoveInvItem(int pnum, int iv) {
  ...
  v8 = --plr[v4]._pNumInv;
  if (v8 > 0 && v8 != v7) {
    qmemcpy((char *)&plr[0].InvList[v7] + v4 * 21720,
            (char *)&plr[0].InvList[v8] + v4 * 21720, 0x170u);
    v9 = 0;
    do {
  ...
  if (_LOBYTE(plr[v4]._pRSplType) == 2) {
    v11 = plr[v4]._pRSpell;
    if (v11 != -1) {
      if (!(plr[v4]._pScrlSpells[1] & (1 << (v11 - 1) >> 31) |
            plr[v4]._pScrlSpells[0] & (1 << (v11 - 1))))
        plr[v4]._pRSpell = -1;
      drawpanflag = 255;
    }
  }
...
void __fastcall RemoveSpdBarItem(int pnum, int iv) {
  ...
  if (_LOBYTE(plr[v2]._pRSplType) == 2) {
    v3 = plr[v2]._pRSpell;
    if (v3 != -1 && !(plr[v2]._pScrlSpells[1] & (1 << (v3 - 1) >> 31) |
                      plr[v2]._pScrlSpells[0] & (1 << (v3 - 1))))
      plr[v2]._pRSpell = -1;
  }
  drawpanflag = 255;
}
...
void __fastcall InvGetItem(int pnum, int ii) {
  ...
  if (dItem[item[ii]._ix][item[ii]._iy]) {
    if (myplr == pnum && pcurs >= CURSOR_FIRSTITEM)
      NetSendCmdPItem(1u, CMD_SYNCPUTITEM, plr[myplr].WorldX,
                      plr[myplr].WorldY);
...
void __fastcall AutoGetItem(int pnum, int ii) {
  ...
  if (ii == 127 || dItem[item[ii]._ix][item[ii]._iy]) {
    ...
    if (plr[v2].HoldItem._itype == ITYPE_GOLD) {
      ...
      v4 = 0;
      if ((!(plr[v3]._pgfxnum & 0xF) || (plr[v3]._pgfxnum & 0xF) == 1) &&
          plr[v3]._pmode <= PM_WALK3) {
        if (plr[v3].HoldItem._iStatFlag) {
      ...
      if (icursW28 == 1) {
        if (icursH28 == 1) {
          if (plr[v3].HoldItem._iStatFlag &&
              AllItemsList[plr[v3].HoldItem.IDidx].iUsable) {
            iia = 0;
            v24 = plr[v3].SpdList;
            do {
              if (v4)
...
int __fastcall FindGetItem(int indx, unsigned short ci, int iseed) {
  ...
  while (1) {
    ii = itemactive[i];
    if (item[ii].IDidx == indx && item[ii]._iSeed == iseed &&
...
void __fastcall SyncGetItem(int x, int y, int idx, unsigned short ci,
  ...
  v5 = dItem[x][y];
  if (v5 && (v6 = v5 - 1, v7 = v6, item[v7].IDidx == idx) &&
      item[v7]._iSeed == iseed && item[v7]._iCreateInfo == ci) {
...
int __cdecl TryInvPut() {
  ...
  if (CanPut(v4 + offset_x[v1], v3 + offset_y[v1]) ||
      ...
      CanPut(v4 + offset_x[((_BYTE)v5 + 2) & 7],
             v3 + offset_y[((_BYTE)v5 + 2) & 7])) {
    result = 1;
  } else {
    result = CanPut(v4, v3);
  }
...
int __fastcall InvPutItem(int pnum, int x, int y) {
  ...
  v5 = y;
  if (FindGetItem(plr[pnum].HoldItem.IDidx, x, plr[pnum].HoldItem._iSeed) !=
      -1) {
    DrawInvMsg("A duplicate item has been detected.  Destroying duplicate...");
    SyncGetItem(xa, y, plr[v3].HoldItem.IDidx, plr[v3].HoldItem._iCreateInfo,
                *v4);
  }
...
int __fastcall SyncPutItem(int pnum, int x, int y, int idx, int icreateinfo,
  ...
  if (!CanPut(v13, v15)) {
    ...
    if (!CanPut(v18 + *(int *)((char *)offset_x + v20),
                v19 + *(int *)((char *)offset_y + v20))) {
      v21 = ((_BYTE)ia + 2) & 7;
...
int __cdecl CheckInvHLight() {
  ...
  if (v0 < 13 || v0 > 18) {
    ...
    if (v0 < 25 || v0 > 64) {
      ...
      result =
          abs(v3->InvGrid[v0 - 25]); // abs(*((char *)&v3->InvList[39]._iVAdd2 +
                                     // v0 + 3)); /* find right address */
      if (result) {
        v4 = result - 1;
        v9 = v4 + 7;
        v2 = &v3->InvList[v4];
...
void __fastcall RemoveScroll(int pnum) {
  ...
  LABEL_8:
    ...
    while (*(v6 - 53) == -1 || *v6 != IMISC_SCROLL && *v6 != IMISC_SCROLLT ||
           v6[1] != plr[v1]._pSpell) {
      ++v5;
      v6 += 92;
      if (v5 >= 8)
    ...
    while (*(v4 - 53) == -1 || *v4 != IMISC_SCROLL && *v4 != IMISC_SCROLLT ||
           v4[1] != plr[v1]._pSpell) {
      ++v3;
      v4 += 92;
      if (v3 >= v2)
...
bool __cdecl UseScroll() {
  ...
  if (pcurs != CURSOR_HAND ||
      !leveltype && !*(_DWORD *)&spelldata[plr[myplr]._pRSpell].sTownSpell)
    return 0;
  v0 = myplr;
  v1 = 0;
  ...
  LABEL_11:
    ...
    while (*(v5 - 53) == -1 || *v5 != IMISC_SCROLL && *v5 != IMISC_SCROLLT ||
           v5[1] != plr[v0]._pRSpell) {
      ++v4;
      v5 += 92;
      if (v4 >= 8)
        return 0;
    ...
    while (*(v3 - 53) == -1 || *v3 != IMISC_SCROLL && *v3 != IMISC_SCROLLT ||
           v3[1] != plr[v0]._pRSpell) {
      ++v1;
      v3 += 92;
      if (v1 >= v2)
        goto LABEL_11;
...
int __fastcall UseInvItem(int pnum, int cii) {
  ...
  LABEL_39:
    ...
    } else if (*(int *)((char *)&plr[0].InvList[0]._iMiscId + v5) !=
               IMISC_MAPOFDOOM) {
      RemoveInvItem(p, v4);
    }
    return 1;
...
void __cdecl DoTelekinesis() {
  ...
  if (pcursmonst != -1 && !M_Talker(pcursmonst) &&
      !monster[pcursmonst].mtalkmsg)
