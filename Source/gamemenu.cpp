...
TMenuItem sgSingleMenu[6] = {{0x80000000, "Save Game", &gamemenu_save_game},
...
//----- (004188D8) --------------------------------------------------------
void __cdecl gamemenu_off() { gmenu_call_proc(0, 0); }
...
//----- (00418A42) --------------------------------------------------------
void __cdecl gamemenu_restart_town() { NetSendCmd(1u, CMD_RETOWN); }
...
void __cdecl gamemenu_get_color_cycling() {
  sgOptionMenu[3].pszStr =
      color_cycling_toggle_names[palette_get_colour_cycling()];
}
...
void __cdecl gamemenu_color_cycling() {
  ...
  sgOptionMenu[3].pszStr =
      color_cycling_toggle_names[palette_get_colour_cycling() & 1];
}
