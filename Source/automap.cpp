...
//----- (00402233) --------------------------------------------------------
void __fastcall DrawAutomapType(int screen_x, int screen_y,
                                short automap_type) {
  short v3;          // al
  int v4;            // ebx
  int v5;            // edi
  ...
  if (automap_type < 0) {
    engine_draw_automap_pixels(v4 - AMPlayerX, v5 - AMPlayerX - AMPlayerY,
                               v4 + AMPlayerX + AutoMapYPos, AMPlayerY + v5,
                               144);
    engine_draw_automap_pixels(v4 - AutoMapYPos, v5 - AMPlayerX,
                               AutoMapYPos + v4, AMPlayerX + v5, 144);
    engine_draw_automap_pixels(v4 - AutoMapYPos - AMPlayerX, v5 - AMPlayerY,
                               AMPlayerX + v4, v5 + AMPlayerX + AMPlayerY, 144);
  ...
  case 1:
    ...
    engine_draw_automap_pixels(v4, v5 - AutoMapYPos, v4 - AutoMapYPos,
                               v5 - AMPlayerX, 200);
  ...
  LABEL_8:
    if (automap_type & 0x100) {
      ...
      engine_draw_automap_pixels(v4, v5 - AutoMapYPos, v4 - AMPlayerX,
                                 v5 - AutoMapYPos + AMPlayerY, 200);
    ...
    if (!(v33 & 0x15))
      engine_draw_automap_pixels(v4, v5 - AutoMapYPos, v4 - AutoMapXPos, v5,
                                 200);
    if (v31)
      goto LABEL_17;
    goto LABEL_25;
  ...
  LABEL_17:
    ...
    if (v33 & 0x20) {
      engine_draw_automap_pixels(AutoMapYPos + v4, v5 - AMPlayerX,
                                 v4 + AutoMapXPos, v5, 200);
      v33 |= 8u;
    }
    if (v33 & 8) {
  ...
  LABEL_26:
    if (v33 & 1) {
      ...
      engine_draw_automap_pixels(v4, AutoMapYPos + v5, v4 - AMPlayerX,
                                 AutoMapYPos + v5 - AMPlayerY, 200);
      ...
      engine_draw_automap_pixels(v4, AutoMapYPos + v5, v4 - AutoMapXPos, v5,
                                 200);
    }
  LABEL_32:
    if (v32) {
    LABEL_33:
      if (v33 & 2) {
        ...
        engine_draw_automap_pixels(v4, AutoMapYPos + v5, v4 + AMPlayerX,
                                   AutoMapYPos + v5 - AMPlayerY, 200);
        engine_draw_automap_pixels(v27, v5, v27 - AMPlayerX, v5 + AMPlayerY,
                                   200);
...
void __cdecl DrawAutomapPlr() {
  ...
  v3 = (AutoMapScale * ScrollInfo._sxoff / 100 >> 1) +
       (AutoMapScale * plr[v0]._pxoff / 100 >> 1) + AutoMapYPos * (v11 - v12) +
       384;
  if (invflag || sbookflag)
    v3 = (AutoMapScale * ScrollInfo._sxoff / 100 >> 1) +
         (AutoMapScale * plr[v0]._pxoff / 100 >> 1) +
         AutoMapYPos * (v11 - v12) + 224;
  if (chrflag || questlog)
    v3 += 160;
  v4 = AMPlayerX * (v12 + v11) + (AutoMapScale * ScrollInfo._syoff / 100 >> 1) +
       (AutoMapScale * plr[v0]._pyoff / 100 >> 1) + 336 - AMPlayerX;
  switch (plr[v0]._pdir) {
  case DIR_S:
    engine_draw_automap_pixels(v3, v4, v3, v4 + AutoMapYPos, 153);
    engine_draw_automap_pixels(v3, AutoMapYPos + v4, v3 + AMPlayerY,
                               v4 + AMPlayerX, 153);
    v10 = v4 + AMPlayerX;
    v9 = v3 - AMPlayerY;
    v5 = AutoMapYPos + v4;
  ...
  case DIR_SW:
    engine_draw_automap_pixels(
        ...
        AMPlayerX * (v12 + v11) +
            (AutoMapScale * ScrollInfo._syoff / 100 >> 1) +
            (AutoMapScale * plr[v0]._pyoff / 100 >> 1) + 336,
        153);
    engine_draw_automap_pixels(v3 - AutoMapYPos, AMPlayerX + v4,
                               v3 - AMPlayerY - AMPlayerX, v4, 153);
    v7 = AMPlayerX;
    v8 = v3;
    v5 = AMPlayerX + v4;
    v10 = AMPlayerX + v4;
  ...
  case DIR_W:
    ...
    engine_draw_automap_pixels(v3 - AutoMapYPos, v4, v3 - AMPlayerX,
                               v4 - AMPlayerY, 153);
    v5 = v4;
    v10 = v4 + AMPlayerY;
    v9 = v3 - AMPlayerX;
  ...
  case DIR_NW:
    ...
    engine_draw_automap_pixels(v3 - AutoMapYPos, v4 - AMPlayerX, v3 - AMPlayerX,
                               v4 - AMPlayerX, 153);
    v7 = AMPlayerX;
    v8 = v3 - AMPlayerY;
    v10 = v4;
  ...
  case DIR_N:
    engine_draw_automap_pixels(v3, v4, v3, v4 - AutoMapYPos, 153);
    engine_draw_automap_pixels(v3, v4 - AutoMapYPos, v3 - AMPlayerY,
                               v4 - AMPlayerX, 153);
    v10 = v4 - AMPlayerX;
    v5 = v4 - AutoMapYPos;
    v9 = v3 + AMPlayerY;
  ...
  case DIR_NE:
    engine_draw_automap_pixels(v3, v4, v3 + AutoMapYPos, v4 - AMPlayerX, 153);
    engine_draw_automap_pixels(AutoMapYPos + v3, v4 - AMPlayerX, v3 + AMPlayerX,
                               v4 - AMPlayerX, 153);
    v10 = v4;
  ...
  case DIR_E:
    engine_draw_automap_pixels(v3, v4, v3 + AutoMapYPos, v4, 153);
    engine_draw_automap_pixels(AutoMapYPos + v3, v4, v3 + AMPlayerX,
                               v4 - AMPlayerY, 153);
    engine_draw_automap_pixels(AutoMapYPos + v3, v4, v3 + AMPlayerX,
                               v4 + AMPlayerY, 153);
    break;
  case DIR_SE:
    engine_draw_automap_pixels(
        ...
        AMPlayerX * (v12 + v11) +
            ...
            (AutoMapScale * plr[v0]._pyoff / 100 >> 1) + 336,
        153);
    engine_draw_automap_pixels(AutoMapYPos + v3, AMPlayerX + v4,
                               v3 + AMPlayerX + AMPlayerY, v4, 153);
    v5 = AMPlayerX + v4;
    v10 = AMPlayerX + v4;
    v9 = v3 + AMPlayerX;
  LABEL_17:
...
void __fastcall SetAutomapView(int x, int y) {
  ...
  if (GetAutomapType(v2 - 1, v12, 0) & 0x4000)
    automapview[-1][v4 - 1] =
        1; /* *((_BYTE *)&AMdword_4B7E40 + v4 + 3) = 1; fix */
}
// 4B7E40: using guessed type int AMdword_4B7E40;
// 4B7E44: using guessed type int AMdword_4B7E44;
