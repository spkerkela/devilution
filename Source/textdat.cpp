...
TextDataStruct alltext[259] = {
    {" Ahh, the story of our King, is it? The tragic fall of Leoric was a "
     "harsh blow to this land. The people always loved the King, and now they "
     "live in mortal fear of him. The question that I keep asking myself is "
     "how he could have fallen so far from the Light, as Leoric had always "
     "been the holiest of men. Only the vilest powers of Hell could so utterly "
     "destroy a man from within... |",
     1, 5, TSFX_STORY1},
    {"The village needs your help, good master! Some months ago King Leoric's "
     ...
     "seemed to slip deeper into madness. He sought to blame innocent "
     "townsfolk for the boy's disappearance and had them brutally executed. "
     "Less than half of us survived his insanity...\n \nThe King's Knights and "
     "Priests tried to placate him, but he turned against them and sadly, they "
     "were forced to kill him. With his dying breath the King called down a "
     "terrible curse upon his former followers. He vowed that they would serve "
     "him in darkness forever...\n \nThis is where things take an even darker "
     "twist than I thought possible! Our former King has risen from his "
     "eternal sleep and now commands a legion of undead minions within the "
     "Labyrinth. His body was buried in a tomb three levels beneath the "
     "Cathedral. Please, good master, put his soul at ease by destroying his "
     "now cursed form... |",
     1, 5, TSFX_TAVERN21},
    {"As I told you, good master, the King was entombed three levels below. "
     "He's down there, waiting in the putrid darkness for his chance to "
     "destroy this land... |",
     1, 6, TSFX_TAVERN22},
    {"The curse of our King has passed, but I fear that it was only part of a "
     "greater evil at work. However, we may yet be saved from the darkness "
     "that consumes our land, for your victory is a good omen. May Light guide "
     "you on your way, good master. |",
     1, 5, TSFX_TAVERN23},
    ...
    {"I don't like to think about how the King died. I like to remember him "
     "for the kind and just ruler that he was. His death was so sad and seemed "
     "very wrong, somehow. |",
     1, 6, TSFX_BMAID1},
    {"I made many of the weapons and most of the armor that King Leoric used "
     "to outfit his knights. I even crafted a huge two-handed sword of the "
     "finest mithril for him, as well as a field crown to match. I still "
     "cannot believe how he died, but it must have been some sinister force "
    ...
    {"Look, I'm running a business here. I don't sell information, and I don't "
     "care about some King that's been dead longer than I've been alive. If "
     "you need something to use against this King of the undead, then I can "
     "help you out... |",
     1, 5, TSFX_PEGBOY1},
    ...
    {"I see that this strange behavior puzzles you as well. I would surmise "
     ...
     "holds great power, it may be that the rising sun depicted on the sign "
     "you speak of has led them to believe that it too holds some arcane "
     "powers. Hmm, perhaps they are not all as smart as we had feared... |",
     1, 5, TSFX_STORY2},
    ...
    {"Oh my! Is that where the sign went? My Grandmother and I must have slept "
     "right through the whole thing. Thank the Light that those monsters "
     "didn't attack the inn. |",
     1, 6, TSFX_BMAID2},
    {"Demons stole Ogden's sign, you say? That doesn't sound much like the "
     "atrocities I've heard of - or seen. \n \nDemons are concerned with "
    ...
    {"What - is he saying I took that? I suppose that Griswold is on his side, "
     "too. \n \nLook, I got over simple sign stealing months ago. You can't "
    ...
    {"Hey - You that one that kill all! You get me Magic Banner or we attack! "
     ...
     1, 5, USFX_SNOT1},
    {"You kill uglies, get banner. You bring to me, or else... |", 1, 6,
     USFX_SNOT2},
    {"You give! Yes, good! Go now, we strong. We kill all with big Magic! |", 1,
     6, USFX_SNOT3},
    {"This does not bode well, for it confirms my darkest fears. While I did "
     ...
     "Deckard Cain the Elder, and I am the last descendant of an ancient "
     "Brotherhood that was dedicated to safeguarding the secrets of a timeless "
     "evil. An evil that quite obviously has now been released.\n \nThe "
     "Archbishop Lazarus, once King Leoric's most trusted advisor, led a party "
     "of simple townsfolk into the Labyrinth to find the King's missing son, "
     "Albrecht. Quite some time passed before they returned, and only a few of "
     "them escaped with their lives.\n \nCurse me for a fool! I should have "
     "suspected his veiled treachery then. It must have been Lazarus himself "
     "who kidnapped Albrecht and has since hidden him within the Labyrinth. I "
     "do not understand why the Archbishop turned to the darkness, or what his "
     "interest is in the child. unless he means to sacrifice him to his dark "
     "masters!\n \nThat must be what he has planned! The survivors of his "
     "'rescue party' say that Lazarus was last seen running into the deepest "
     "bowels of the labyrinth. You must hurry and save the prince from the "
     "sacrificial blade of this demented fiend! |",
     1, 3, TSFX_STORY36},
    ...
    {"Your story is quite grim, my friend. Lazarus will surely burn in Hell "
     "for his horrific deed. The boy that you describe is not our prince, but "
     "I believe that Albrecht may yet be in danger. The symbol of power that "
     "you speak of must be a portal in the very heart of the labyrinth.\n "
     "\nKnow this, my friend - The evil that you move against is the dark Lord "
     "of Terror. He is known to mortal men as Diablo. It was he who was "
     "imprisoned within the Labyrinth many centuries ago and I fear that he "
     "seeks to once again sow chaos in the realm of mankind. You must venture "
     "through the portal and destroy Diablo before it is too late! |",
     1, 5, TSFX_STORY38},
    ...
    {"I did not know this Lazarus of whom you speak, but I do sense a great "
     ...
     "nothing to serve the powers of darkness which have claimed him as "
     "theirs. |",
     1, 5, TSFX_WITCH3},
    ...
    {"I have always tried to keep a large supply of foodstuffs and drink in "
     "our storage cellar, but with the entire town having no source of fresh "
     "water, even our stores will soon run dry. \n \nPlease, do what you can "
     "or I don't know what we will do. |",
     1, 6, TSFX_TAVERN2},
    {"I'm glad I caught up to you in time! Our wells have become brackish and "
     "stagnant and some of the townspeople have become ill drinking from them. "
     "Our reserves of fresh water are quickly running dry. I believe that "
     "there is a passage that leads to the springs that serve our town. Please "
     "find what has caused this calamity, or we all will surely perish. |",
     1, 5, TSFX_HEALER20},
    {"Please, you must hurry. Every hour that passes brings us closer to "
     "having no water to drink. \n \nWe cannot survive for long without your "
     "help. |",
     1, 6, TSFX_HEALER21},
    ...
    {"A book that speaks of a chamber of human bones? Well, a Chamber of Bone "
     ...
     "desired to protect great treasures, they would create domains where "
     "those who died in the attempt to steal that treasure would be forever "
     "bound to defend it. A twisted, but strangely fitting, end? |",
     1, 4, TSFX_STORY7},
    ...
    {"I know nothing of this place, but you may try asking Cain. He talks "
     "about many things, and it would not surprise me if he had some answers "
     "to your question. |",
     1, 6, TSFX_SMITH7},
    ...
    {"You will become an eternal servant of the dark lords should you perish "
     "within this cursed domain. \n \nEnter the Chamber of Bone at your own "
     "peril. |",
     1, 6, TSFX_WITCH7},
    ...
    {"By the Light, I know of this vile demon. There were many that bore the "
     "scars of his wrath upon their bodies when the few survivors of the "
     "charge led by Lazarus crawled from the Cathedral. I don't know what he "
     "used to slice open his victims, but it could not have been of this "
     "world. It left wounds festering with disease and even I found them "
     "almost impossible to treat. Beware if you plan to battle this fiend... |",
     1, 5, TSFX_HEALER8},
    {"When Farnham said something about a butcher killing people, I "
     "immediately discounted it. But since you brought it up, maybe it is "
     "true. |",
     1, 6, TSFX_BMAID8},
    {"I saw what Farnham calls the Butcher as it swathed a path through the "
     "bodies of my friends. He swung a cleaver as large as an axe, hewing "
     "limbs and cutting down brave men where they stood. I was separated from "
     "the fray by a host of small screeching demons and somehow found the "
     "stairway leading out. I never saw that hideous beast again, but his "
    ...
    {"I know more than you'd think about that grisly fiend. His little friends "
     ...
     "of that hole. \n \nI'll put it bluntly - kill him before he kills you "
     "and adds your corpse to his collection. |",
     1, 6, TSFX_PEGBOY10},
    {"Please, listen to me. The Archbishop Lazarus, he led us down here to "
     "find the lost prince. The bastard led us into a trap! Now everyone is "
     "dead...killed by a demon he called the Butcher. Avenge us! Find this "
     "Butcher and slay him so that our souls may finally rest... |",
     1, 5, TSFX_WOUND},
    {" |", 1, 5, USFX_CLEAVER},
    {"You recite an interesting rhyme written in a style that reminds me of "
     ...
     "Hidden. Eyes glowing unseen with only the sounds of razor claws briefly "
    ...
    {"I never much cared for poetry. Occasionally, I had cause to hire "
     ...
     "time ago now. \n \nWhat? Oh, yes... uh, well, I suppose you could see "
    ...
    {"I am afraid that I have neither heard nor seen a place that matches your "
     ...
     "some help. |",
     1, 6, TSFX_SMITH12},
    {"Look here... that's pretty funny, huh? Get it? Blind - look here? |", 1,
     6, TSFX_DRUNK12},
    {"This is a place of great anguish and terror, and so serves its master "
     "well. \n \nTread carefully or you may yourself be staying much longer "
    ...
    {"You claim to have spoken with Lachdanan? He was a great hero during his "
     ...
     "who were caught within the grasp of the King's Curse, Lachdanan would be "
     "the least likely to submit to the darkness without a fight, so I suppose "
     "that your story could be true. If I were in your place, my friend, I "
    ...
    {"A golden elixir, you say. I have never concocted a potion of that color "
     "before, so I can't tell you how it would effect you if you were to try "
     "to drink it. As your healer, I strongly advise that should you find such "
     "an elixir, do as Lachdanan asks and DO NOT try to use it. |",
     1, 5, TSFX_HEALER11},
    ...
    {"You may meet people who are trapped within the Labyrinth, such as "
     "Lachdanan. \n \nI sense in him honor and great guilt. Aid him, and you "
     "aid all of Tristram. |",
     1, 6, TSFX_WITCH13},
    {"Wait, let me guess. Cain was swallowed up in a gigantic fissure that "
     ...
     "answer your questions anymore. Oh, that isn't what happened? Then I "
     "guess you'll be buying something or you'll be on your way. |",
     1, 5, TSFX_PEGBOY12},
    {"Please, don't kill me, just hear me out. I was once Captain of King "
     "Leoric's Knights, upholding the laws of this land with justice and "
     "honor. Then his dark Curse fell upon us for the role we played in his "
     "tragic death. As my fellow Knights succumbed to their twisted fate, I "
     "fled from the King's burial chamber, searching for some way to free "
     "myself from the Curse. I failed...\n \nI have heard of a Golden Elixir "
     "that could lift the Curse and allow my soul to rest, but I have been "
     "unable to find it. My strength now wanes, and with it the last of my "
     "humanity as well. Please aid me and find the Elixir. I will repay your "
    ...
    {"You have saved my soul from damnation, and for that I am in your debt. "
     "If there is ever a way that I can repay you from beyond the grave I will "
    ...
    {"Griswold speaks of The Anvil of Fury - a legendary artifact long "
     ...
     "Razor Pit demons, the Anvil of Fury was smelt around the skulls of the "
     "five most powerful magi of the underworld. Carved with runes of power "
     "and chaos, any weapon or armor forged upon this Anvil will be immersed "
     "into the realm of Chaos, imbedding it with magical properties. It is "
     "said that the unpredictable nature of Chaos makes it difficult to know "
     "what the outcome of this smithing will be... |",
     1, 4, TSFX_STORY14},
    ...
    {"Griswold's father used to tell some of us when we were growing up about "
     "a giant anvil that was used to make mighty weapons. He said that when a "
    ...
    {"Greetings! It's always a pleasure to see one of my best customers! I "
     "know that you have been venturing deeper into the Labyrinth, and there "
     "is a story I was told that you may find worth the time to listen to...\n "
     ...
     "powerful weapons of magic are crafted. The legend had it that deep "
     "within the Hellforge rested the Anvil of Fury! This Anvil contained "
     "within it the very essence of the demonic underworld...\n \nIt is said "
     "that any weapon crafted upon the burning Anvil is imbued with great "
     "power. If this anvil is indeed the Anvil of Fury, I may be able to make "
    ...
    {"There are many artifacts within the Labyrinth that hold powers beyond "
     "the comprehension of mortals. Some of these hold fantastic power that "
     "can be used by either the Light or the Darkness. Securing the Anvil from "
     "below could shift the course of the Sin War towards the Light. |",
     1, 5, TSFX_WITCH14},
    ...
    {"The Gateway of Blood and the Halls of Fire are landmarks of mystic "
     ...
     "great power.\n \nLegends speak of a pedestal that is carved from "
     "obsidian stone and has a pool of boiling blood atop its bone encrusted "
     "surface. There are also allusions to Stones of Blood that will open a "
     "door that guards an ancient treasure...\n \nThe nature of this treasure "
     "is shrouded in speculation, my friend, but it is said that the ancient "
     "hero Arkaine placed the holy armor Valor in a secret vault. Arkaine was "
     "the first mortal to turn the tide of the Sin War and chase the legions "
     "of darkness back to the Burning Hells.\n \nJust before Arkaine died, his "
     "armor was hidden away in a secret vault. It is said that when this holy "
     "armor is again needed, a hero will arise to don Valor once more. Perhaps "
     "you are that hero... |",
     1, 3, TSFX_STORY15},
    ...
    {"Should you find these Stones of Blood, use them carefully. \n \nThe way "
     "is fraught with danger and your only hope rests within your self trust. "
     "|",
     1, 6, TSFX_WITCH15},
    {"You intend to find the armor known as Valor? \n \nNo one has ever "
     "figured out where Arkaine stashed the stuff, and if my contacts couldn't "
     "find it, I seriously doubt you ever will either. |",
     1, 6, TSFX_PEGBOY14},
    {"I know of only one legend that speaks of such a warrior as you describe. "
     ...
     "Blood stands upon a mountain of his tattered victims. His dark blade "
     "screams a black curse to the living; a tortured invitation to any who "
     "would stand before this Executioner of Hell.\n \nIt is also written that "
     "although he was once a mortal who fought beside the Legion of Darkness "
     "during the Sin War, he lost his humanity to his insatiable hunger for "
     "blood. |",
     1, 5, TSFX_STORY18},
    ...
    {"I haven't ever dealt with this Warlord you speak of, but he sounds like "
     "he's going through a lot of swords. Wouldn't mind supplying his "
     "armies... |",
     1, 6, TSFX_PEGBOY17},
    ...
    {"Well, a caravan of some very important people did stop here, but that "
     ...
     "long journey, as I recall. \n \nI don't see how you could hope to find "
     "anything that they would have been carrying. |",
     1, 6, TSFX_BMAID18},
    {"Stay for a moment - I have a story you might find interesting. A caravan "
     "that was bound for the eastern kingdoms passed through here some time "
     "ago. It was supposedly carrying a piece of the heavens that had fallen "
     "to earth! The caravan was ambushed by cloaked riders just north of here "
    ...
    {"The witch Adria seeks a black mushroom? I know as much about Black "
     ...
     "tell you more, but this is something that cannot be found in any of my "
     "stories or books. |",
     1, 5, TSFX_STORY21},
    ...
    {"What do we have here? Interesting, it looks like a book of reagents. "
     "Keep your eyes open for a black mushroom. It should be fairly large and "
     "easy to identify. If you find it, bring it to me, won't you? |",
     1, 5, TSFX_WITCH22},
    ...
    {"Yes, this will be perfect for a brew that I am creating. By the way, the "
     ...
     "those who have been afflicted by their poisonous venom. I believe that "
     "he intends to make an elixir from it. If you help him find what he "
    ...
    {"Why have you brought that here? I have no need for a demon's brain at "
     "this time. I do need some of the elixir that the Healer is working on. "
     "He needs that grotesque organ that you are holding, and then bring me "
     "the elixir. Simple when you think about it, isn't it? |",
     1, 5, TSFX_WITCH25},
    ...
    {"I don't have any mushrooms of any size or color for sale. How about "
     ...
     1, 6, TSFX_PEGBOY19},
    {"So, the legend of the Map is real. Even I never truly believed any of "
     "it! I suppose it is time that I told you the truth about who I am, my "
     "friend. You see, I am not all that I seem...\n \nMy true name is Deckard "
     "Cain the Elder, and I am the last descendant of an ancient Brotherhood "
     "that was dedicated to keeping and safeguarding the secrets of a timeless "
     "evil. An evil that quite obviously has now been released...\n \nThe evil "
     "that you move against is the dark Lord of Terror - known to mortal men "
     "as Diablo. It was he who was imprisoned within the Labyrinth many "
     "centuries ago. The Map that you hold now was created ages ago to mark "
     "the time when Diablo would rise again from his imprisonment. When the "
     "two stars on that map align, Diablo will be at the height of his power. "
     "He will be all but invincible...\n \nYou are now in a race against time, "
     "my friend! Find Diablo and destroy him before the stars align, for we "
     "may never have a chance to rid the world of his evil again! |",
     1, 2, TSFX_STORY22},
    ...
    {"I am sure that you tried your best, but I fear that even your strength "
     ...
     "power, and you will need all your courage and strength to defeat him. "
     "May the Light protect and guide you, my friend. I will help in any way "
     "that I am able. |",
     1, 5, TSFX_STORY24},
    {"If the witch can't help you and suggests you see Cain, what makes you "
     ...
     "matter. You should hurry along and see the storyteller as Adria "
     "suggests. |",
     1, 6, TSFX_TAVERN20},
    {"I can't make much of the writing on this map, but perhaps Adria or Cain "
     "could help you decipher what this refers to. \n \nI can see that it is a "
     "map of the stars in our sky, but any more than that is beyond my "
     "talents. |",
     1, 6, TSFX_HEALER19},
    {"The best person to ask about that sort of thing would be our "
     "storyteller. \n \nCain is very knowledgeable about ancient writings, and "
     "that is easily the oldest looking piece of paper that I have ever seen. "
     "|",
     1, 6, TSFX_BMAID20},
    {"I have never seen a map of this sort before. Where'd you get it? "
     "Although I have no idea how to read this, Cain or Adria may be able to "
    ...
    {"I've been looking for a map, but that certainly isn't it. You should "
     "show that to Adria - she can probably tell you what it is. I'll say one "
    ...
    {"Nothing yet! Almost done. \n \nVery powerful, very strong. Live! Live! "
     ...
     1, 6, USFX_GARBUD3},
    {"This too good for you. Very Powerful! You want - you take! |", 1, 6,
     USFX_GARBUD4},
    ...
    {"While you are venturing deeper into the Labyrinth you may find tomes of "
     "great knowledge hidden there. \n \nRead them carefully for they can tell "
     "you things that even I cannot. |",
     1, 6, TSFX_STORY26},
    ...
    {"Griswold - a man of great action and great courage. I bet he never told "
     ...
     "help you in any way, you can count on his honesty and his skill. |",
     1, 5, TSFX_STORY28},
    {"Ogden has owned and run the Rising Sun Inn and Tavern for almost four "
     "years now. He purchased it just a few short months before everything "
     "here went to hell. He and his wife Garda do not have the money to leave "
     "as they invested all they had in making a life for themselves here. He "
     "is a good man with a deep sense of responsibility. |",
     1, 5, TSFX_STORY29},
    ...
    {"The witch, Adria, is an anomaly here in Tristram. She arrived shortly "
     ...
     "She had a small hut constructed at the edge of town, seemingly "
     "overnight, and has access to many strange and arcane artifacts and tomes "
     "of knowledge that even I have never seen before. |",
     1, 5, TSFX_STORY31},
    ...
    {"Ah, Pepin. I count him as a true friend - perhaps the closest I have "
     "here. He is a bit addled at times, but never a more caring or "
     "considerate soul has existed. His knowledge and skills are equaled by "
     "few, and his door is always open. |",
     1, 5, TSFX_STORY34},
    {"Gillian is a fine woman. Much adored for her high spirits and her quick "
     "laugh, she holds a special place in my heart. She stays on at the tavern "
     "to support her elderly grandmother who is too sick to travel. I "
     "sometimes fear for her safety, but I know that any man in the village "
     "would rather die than see her harmed. |",
     1, 5, TSFX_STORY35},
    {"Greetings, good master. Welcome to the Tavern of the Rising Sun! |", 0, 5,
     TSFX_TAVERN36},
    ...
    {"Farnham spends far too much time here, drowning his sorrows in cheap "
     "ale. I would make him leave, but he did suffer so during his time in the "
     "Labyrinth. |",
     1, 6, TSFX_TAVERN39},
    {"Adria is wise beyond her years, but I must admit - she frightens me a "
     "little. \n \nWell, no matter. If you ever have need to trade in items of "
     "sorcery, she maintains a strangely well-stocked hut just across the "
     "river. |",
     1, 6, TSFX_TAVERN40},
    ...
    {"Wirt is a rapscallion and a little scoundrel. He was always getting into "
     ...
     "went fooling about someplace that he shouldn't have been. I feel sorry "
    ...
    {"Gillian, my Barmaid? If it were not for her sense of duty to her "
     "grand-dam, she would have fled from here long ago. \n \nGoodness knows I "
     "begged her to leave, telling her that I would watch after the old woman, "
     "but she is too sweet and caring to have done so. |",
     1, 6, TSFX_TAVERN45},
    {"What ails you, my friend? |", 0, 5, TSFX_HEALER37},
    {"I have made a very interesting discovery. Unlike us, the creatures in "
     "the Labyrinth can heal themselves without the aid of potions or magic. "
     "If you hurt one of the monsters, make sure it is dead or it very well "
     "may regenerate itself. |",
     1, 5, TSFX_HEALER38},
    {"Before it was taken over by, well, whatever lurks below, the Cathedral "
     ...
     "If you find any, you should read them all, for some may hold secrets to "
     "the workings of the Labyrinth. |",
     1, 5, TSFX_HEALER39},
    ...
    {"While I use some limited forms of magic to create the potions and "
     "elixirs I store here, Adria is a true sorceress. She never seems to "
     "sleep, and she always has access to many mystic tomes and artifacts. I "
     "believe her hut may be much more than the hovel it appears to be, but I "
     "can never seem to get inside the place. |",
     1, 5, TSFX_HEALER43},
    ...
    {"I really don't understand why Ogden stays here in Tristram. He suffers "
     "from a slight nervous condition, but he is an intelligent and "
     "industrious man who would do very well wherever he went. I suppose it "
     "may be the fear of the many murders that happen in the surrounding "
     "countryside, or perhaps the wishes of his wife that keep him and his "
     "family where they are. |",
     1, 5, TSFX_HEALER46},
    {"Ogden's barmaid is a sweet girl. Her grandmother is quite ill, and "
     "suffers from delusions. \n \nShe claims that they are visions, but I "
     "have no proof of that one way or the other. |",
     1, 6, TSFX_HEALER47},
    ...
    {"The woman at the edge of town is a witch! She seems nice enough, and her "
     ...
     "\n \nIt would take someone quite brave, like you, to see what she is "
     "doing out there. |",
     1, 6, TSFX_BMAID33},
    {"Our Blacksmith is a point of pride to the people of Tristram. Not only "
     "is he a master craftsman who has won many contests within his guild, but "
     "he received praises from our King Leoric himself - may his soul rest in "
    ...
    {"Farnham is a drunkard who fills his belly with ale and everyone else's "
     ...
     "for him, but I get so frustrated watching him slip farther and farther "
     "into a befuddled stupor every night. |",
     1, 6, TSFX_BMAID36},
    ...
    {"I grew up with Wirt's mother, Canace. Although she was only slightly "
     ...
     "think she died of a broken heart. Wirt has become a mean-spirited "
     "youngster, looking only to profit from the sweat of others. I know that "
     "he suffered and has seen horrors that I cannot even imagine, but some of "
     "that darkness hangs over him still. |",
     1, 5, TSFX_BMAID39},
    ...
    {"The axe? Aye, that's a good weapon, balanced against any foe. Look how "
     "it cleaves the air, and then imagine a nice fat demon head in its path. "
     "Keep in mind, however, that it is slow to swing - but talk about dealing "
     "a heavy blow! |",
     1, 5, TSFX_SMITH46},
    {"Look at that edge, that balance. A sword in the right hands, and against "
     ...
     "to hack or pierce on the undead, but against a living, breathing enemy, "
     "a sword will better slice their flesh! |",
     1, 5, TSFX_SMITH47},
    ...
    {"While I have to practically smuggle in the metals and tools I need from "
     ...
     "about how to harness magic as she did, I could make some truly "
     "incredible things. |",
     1, 5, TSFX_SMITH49},
    {"Gillian is a nice lass. Shame that her gammer is in such poor health or "
     "I would arrange to get both of them out of here on one of the trading "
     "caravans. |",
     1, 6, TSFX_SMITH50},
    ...
    {"I was with Farnham that night that Lazarus led us into Labyrinth. I "
     "never saw the Archbishop again, and I may not have survived if Farnham "
     "was not at my side. I fear that the attack left his soul as crippled as, "
     "well, another did my leg. I cannot fight this battle for him now, but I "
     "would if I could. |",
     1, 5, TSFX_SMITH52},
    ...
    {"Cain isn't what he says he is. Sure, sure, he talks a good story... some "
     "of 'em are real scary or funny... but I think he knows more than he "
     "knows he knows. |",
     1, 5, TSFX_DRUNK30},
    ...
    {"No one ever lis... listens to me. Somewhere - I ain't too sure - but "
     ...
     1, 5, TSFX_DRUNK24},
    {"I know you gots your own ideas, and I know you're not gonna believe "
     ...
     "anything like they used to in the old days... |",
     1, 5, TSFX_DRUNK25},
    ...
    {"Corruption has the strength of deceit, but innocence holds the power of "
     ...
     "her matriarch over her own. She fears me, but it is only because she "
     "does not understand me. |",
     1, 5, TSFX_WITCH44},
    {"A chest opened in darkness holds no greater treasure than when it is "
     "opened in the light. The storyteller Cain is an enigma, but only to "
     "those who do not look. His knowledge of what lies beneath the cathedral "
     "is far greater than even he allows himself to realize. |",
     1, 5, TSFX_WITCH45},
    ...
    {"There is much about the future we cannot see, but when it comes it will "
     "be the children who wield it. The boy Wirt has a blackness upon his "
     "soul, but he poses no threat to the town or its people. His secretive "
     "dealings with the urchins and unspoken guilds of nearby towns gain him "
     "access to many devices that cannot be easily found in Tristram. While "
     "his methods may be reproachful, Wirt can provide assistance for your "
    ...
    {"In case you haven't noticed, I don't buy anything from Tristram. I am an "
     "importer of quality goods. If you want to peddle junk, you'll have to "
     "see Griswold, Pepin or that witch, Adria. I'm sure that they will snap "
     "up whatever you can bring them... |",
     1, 5, TSFX_PEGBOY35},
    ...
    {"If I were a few years older, I would shower her with whatever riches I "
     ...
     "stuff. Gillian is a beautiful girl who should get out of Tristram as "
     "soon as it is safe. Hmmm... maybe I'll take her with me when I go... |",
     1, 5, TSFX_PEGBOY37},
    ...
    {"As long as you don't need anything reattached, old Pepin is as good as "
     "they come. \n \nIf I'd have had some of those potions he brews, I might "
     "still have my leg... |",
     1, 6, TSFX_PEGBOY40},
    ...
    {"Ogden is a fool for staying here. I could get him out of town for a very "
     ...
     "stupid tavern. I guess at the least he gives Gillian a place to work, "
     "and his wife Garda does make a superb Shepherd's pie... |",
     1, 5, TSFX_PEGBOY43},
    ...
    {"Take heed and bear witness to the truths that lie herein, for they are "
     ...
     "beyond the fields that we know - between the utopian kingdoms of the "
     "High Heavens and the chaotic pits of the Burning Hells. This war is "
     "known as the Great Conflict, and it has raged and burned longer than any "
     "of the stars in the sky. Neither side ever gains sway for long as the "
     "forces of Light and Darkness constantly vie for control over all "
     "creation. |",
     1, 5, PS_NAR1},
    {"Take heed and bear witness to the truths that lie herein, for they are "
     ...
     "powerful mortals have even allied themselves with either side, and "
     "helped to dictate the course of the Sin War. |",
     1, 4, PS_NAR2},
    {"Take heed and bear witness to the truths that lie herein, for they are "
     ...
     "Horadrim captured two of the Three within powerful artifacts known as "
     "Soulstones and buried them deep beneath the desolate eastern sands. The "
     "third Evil escaped capture and fled to the west with many of the "
     "Horadrim in pursuit. The Third Evil - known as Diablo, the Lord of "
     "Terror - was eventually captured, his essence set in a Soulstone and "
     "buried within this Labyrinth.\n \nBe warned that the soulstone must be "
     "kept from discovery by those not of the faith. If Diablo were to be "
     "released, he would seek a body that is easily controlled as he would be "
     "very weak - perhaps that of an old man or a child. |",
     1, 3, PS_NAR3},
    {"So it came to be that there was a great revolution within the Burning "
     ...
     "Prime Evils and banished their spirit forms to the mortal realm. The "
     "demons Belial (the Lord of Lies) and Azmodan (the Lord of Sin) fought to "
     "claim rulership of Hell during the absence of the Three Brothers. All of "
     "Hell polarized between the factions of Belial and Azmodan while the "
     "forces of the High Heavens continually battered upon the very Gates of "
     "Hell. |",
     1, 4, PS_NAR4},
    ...
    {"So it came to be that the Three Prime Evils were banished in spirit form "
     ...
     "to the west.\n \nEventually the Horadrim captured Diablo within a "
     "Soulstone as well, and buried him under an ancient, forgotten Cathedral. "
     "There, the Lord of Terror sleeps and awaits the time of his rebirth. "
     "Know ye that he will seek a body of youth and power to possess - one "
     "that is innocent and easily controlled. He will then arise to free his "
    ...
    {"All praises to Diablo - Lord of Terror and Survivor of The Dark Exile. "
     ...
     "of secrets that few mortals know. He told me the kingdoms of the High "
     ...
     "Sin War. |",
     1, 4, PS_NAR7},
    {"Glory and Approbation to Diablo - Lord of Terror and Leader of the "
     "Three. My Lord spoke to me of his two Brothers, Mephisto and Baal, who "
     "were banished to this world long ago. My Lord wishes to bide his time "
     ...
     "his Brothers, the Sin War will once again know the fury of the Three. |",
     1, 4, PS_NAR8},
    {"Hail and Sacrifice to Diablo - Lord of Terror and Destroyer of Souls. "
     "When I awoke my Master from his sleep, he attempted to possess a "
     ...
     1, 3, PS_NAR9},
    {"Thank goodness you've returned!\nMuch has changed since you lived here, "
     "my friend. All was peaceful until the dark riders came and destroyed our "
     "village. Many were cut down where they stood, and those who took up arms "
     "were slain or dragged away to become slaves - or worse. The church at "
     "the edge of town has been desecrated and is being used for dark rituals. "
     "The screams that echo in the night are inhuman, but some of our "
     "townsfolk may yet survive. Follow the path that lies between my tavern "
     "and the blacksmith shop to find the church and save who you can. \n "
