...
char PlrGFXAnimLens[3][11] = {{10, 16, 8, 2, 20, 20, 6, 20, 8, 9, 14},
                              {8, 18, 8, 4, 20, 16, 7, 20, 8, 10, 12},
                              {8, 16, 8, 6, 20, 12, 8, 20, 8, 12, 8}};
int PWVel[4][3] = {
    {2048, 1024, 512}, {2048, 1024, 512}, {2048, 1024, 512}, {8, 8, 8}};
...
void __fastcall LoadPlrGFX(int pnum, int gfxflag)
{
  ...
  v3 = &plr[v2];
  sprintf(v15, "%c%c%c", CharChar[SLOBYTE(v3->_pClass)],
          ArmourChar[v3->_pgfxnum >> 4], WepChar[v3->_pgfxnum & 0xF]);
  v4 = 1;
...
int __fastcall CalcStatDiff(int pnum)
{
  ...
  return MaxStats[v2][0] + MaxStats[v2][1] + MaxStats[v2][2] + MaxStats[v2][3] -
         plr[v1]._pBaseVit - plr[v1]._pBaseDex - plr[v1]._pBaseMag -
         plr[v1]._pBaseStr;
}
...
void __fastcall InitPlayer(int pnum, bool FirstTime)
{
  ...
  if (plr[v3].plrlevel == currlevel || leveldebug)
  {
    ...
    if (v14)
      ...
      plr[v3]._plid = -1;
    plr[v3]._pvid = AddVision(plr[v3].WorldX, plr[v3].WorldY,
...
void __fastcall InitPlayerLoc(int pnum, bool flag)
{
  ...
  v4 = plr[v3].WorldX - 1;
  v5 = plr[v3].WorldY + 1;
  v6 = (char *)dpiece_defs_map_1 +
       32 * gendung_get_dpiece_num_from_coord(v4, v5);
  v17 = 2;
  do
    v14 |= *(unsigned short *)&v6[2 * v17++];
  while (v17 < 10);
  if (v14 | dArch[v4][v5] |
      (unsigned char)nSolidTable[dPiece[0][v5 + 112 * v4]])
    plr[v3]._peflag = 1;
  else
    plr[v3]._peflag = 0;
  if (v13 == 1 && plr[v3]._peflag == 1)
  {
    ...
    v15 = 0;
    v8 = plr[v3].WorldY + 2;
    v9 = (char *)dpiece_defs_map_1 +
         32 * gendung_get_dpiece_num_from_coord(plr[v3].WorldX, v8);
    v18 = 2;
    do
    ...
    if (!(v15 | dArch[v7][v8]))
    {
      ...
      v10 = plr[v3].WorldX - 2;
      v11 = plr[v3].WorldY + 1;
      v12 = (char *)dpiece_defs_map_1 +
            32 * gendung_get_dpiece_num_from_coord(v10, v11);
      v19 = 2;
      do
                          ...
                          int EndDir, int sdir)
{
  ...
  if (PlrDirOK(arglist, EndDir))
  {
    ...
    v13 = plr[v8]._pWWidth;
    NewPlrAnim(v11, plr[0]._pWAnim[EndDir + 5430 * v11], plr[v8]._pWFrames, 0,
               v13);
    plr[v8]._pdir = EndDir;
    plr[v8]._pVar6 = 0;
    plr[v8]._pVar7 = 0;
                           ...
                           int xadd, int yadd, int EndDir, int sdir)
{
  ...
  if (PlrDirOK(arglist, EndDir))
  {
    ...
    NewPlrAnim(arglist, plr[0]._pWAnim[EndDir + 5430 * arglist],
               plr[v10]._pWFrames, 0, v18);
    plr[v10]._pVar8 = 0;
    v19 = 0;
...
void __fastcall StartSpell(int pnum, int d, int cx, int cy)
{
  ...
  PlaySfxLoc((unsigned char)spelldata[plr[v5]._pSpell].sSFX, plr[v5].WorldX,
             plr[v5].WorldY);
...
void __fastcall StartPlayerKill(int pnum, int earflag)
{
  ...
  PlaySfxLoc(PS_DEAD, plr[v3 / 0x54D8].WorldX,
             plr[v3 / 0x54D8]
...
LABEL_18:
  ...
  NewPlrAnim(v2, plr[0]._pDAnim[plr[v3 / 0x54D8]._pdir + v3 / 4],
             plr[v3 / 0x54D8]._pDFrames, 1, v6);
      ...
      if (!v20)
      {
        ...
        if (itm != (struct ItemStruct *)-1)
        {
          if (itm)
          {
            ...
            v15 = plr[v3 / 0x54D8]._pName[5] |
                  ((plr[v3 / 0x54D8]._pName[4] |
                    ((v14 | (plr[v3 / 0x54D8]._pName[2] << 8)) << 8))
                   << 8);
...
bool __fastcall PlrHitMonst(int pnum, int m)
{
  ...
  v9 = v3;
  v10 = plr[v9]._pLevel;
  v11 = plr[v9]._pIEnAc + (plr[v9]._pDexterity >> 1) -
        *((unsigned char *)&monster[0].mArmorClass + v5);
  v12 = v11 + v10 + 50;
  ...
  if (CheckMonsterHit(arglist, &ret))
    return ret;
#ifdef _DEBUG
  if ((signed int)v46 < v13 || debug_mode_key_inverted_v ||
...
bool __fastcall PlrHitPlr(int pnum, char p)
{
  ...
  v8 = v3;
  v29 = random(pnum, 100);
  v9 = (plr[v8]._pDexterity >> 1) - plr[v5]._pIBonusAC - plr[v5]._pIAC -
       plr[v5]._pDexterity / 5;
  v10 = plr[v8]._pLevel;
  v11 = v9 + v10 + 50;
  ...
  v15 = plr[v5]._pDexterity + plr[v5]._pBaseToBlk + 2 * plr[v5]._pLevel -
        2 * plr[v8]._pLevel;
  if (v15 < 0)
    v15 = 0;
  if (v15 > 100)
...
int __fastcall PM_DoRangeAttack(int pnum)
{
  ...
  if (v3 & 0x2000000)
    v5 = MIS_LARROW;
  AddMissile(plr[v2].WorldX, plr[v2].WorldY, plr[v2]._pVar1, plr[v2]._pVar2,
...
void __fastcall CheckNewPath(int pnum)
{
  ...
  if (plr[v1].destAction == 20)
    MakePlrPath(v1, monster[plr[v2].destParam1]._mfutx,
                monster[plr[v2].destParam1]._mfuty, 0);
  ...
  if (plr[v2].walkpath[0] == -1)
  {
    ...
    if (v19 == PM_STAND)
    {
      ...
      case 10:
        ...
        goto LABEL_59;
      case 12:
        v39 = GetDirection(plr[v2].WorldX, plr[v2].WorldY, plr[v2].destParam1,
                           plr[v2].destParam2);
      ...
      case 20:
        ...
        if (v23 > 1 || v24 > 1)
          break;
        v20 = GetDirection(plr[v2]._px, plr[v2]._py, monster[v22]._mfutx,
                           monster[v22]._mfuty);
      ...
      case 21:
        ...
        if (v27 > 1 || v28 > 1)
          break;
        v20 =
            GetDirection(plr[v2]._px, plr[v2]._py, plr[v26]._px, plr[v26]._py);
      LABEL_52:
        v29 = v1;
        goto LABEL_82;
      case 22:
        ...
        v35 = GetDirection(plr[v2]._px, plr[v2]._py, monster[v34]._mfutx,
                           monster[v34]._mfuty);
      ...
      LABEL_65:
        ...
        goto LABEL_66;
      case 26:
        StartSpell(v1, plr[v2].destParam3, plr[v2].destParam1,
                   plr[v2].destParam2);
    ...
    if (v19 == 4 && plr[v2]._pAnimFrame > plr[myplr]._pAFNum)
    {
      ...
      case 20:
        ...
        if (v64 > 1 || v65 > 1)
          goto LABEL_107;
        v61 = GetDirection(plr[v2]._px, plr[v2]._py, monster[v63]._mfutx,
                           monster[v63]._mfuty);
        goto LABEL_105;
      case 21:
        ...
        if (v67 > 1 || v68 > 1)
          goto LABEL_107;
        v61 =
            GetDirection(plr[v2]._px, plr[v2]._py, plr[v66]._px, plr[v66]._py);
        v62 = p;
        goto LABEL_106;
      case 13:
  ...
  if (px >= 0 && px < 112 && py >= 0 && py < 112 && !SolidLoc(px, py))
  {
    if (dPiece[px][py])
    {
                  ...
                  v9 == pnum || v9 >= 4 || !plr[v9]._pHitPoints))
      {
        ...
        {
          v11 = dObject[px][py];
          if (!v11 || (v11 <= 0 ? (v12 = -1 - v11) : (v12 = v11 - 1),
                       !object[v12]._oSolidFlag))
            result = 1;
        }
      }
    }
      ...
      do
      {
        ...
        while (v6 <= v13 && !v11)
        {
          ...
          do
          {
            ...
            if (PosOkPlayer(p, v10 + plr[v1].WorldX, v5) &&
                !PosOkPortal(currlevel, v4, v5))
              v11 = 1;
            ++v10;
          } while (v10 <= v13);
          v6 = ++v9;
...
void __fastcall ModifyPlrDex(int pnum, int l)
{
  ...
  if (_LOBYTE(plr[v4]._pClass) == 1)
    plr[v4]._pDamageMod =
        plr[v4]._pLevel * (plr[v4]._pDexterity + plr[v4]._pStrength) / 200;
  if (v2 == myplr)
