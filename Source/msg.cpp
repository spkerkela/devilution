...
//----- (0043BBA9) --------------------------------------------------------
struct msg_cpp_init {
  msg_cpp_init() { msg_cpp_init_value = msg_inf; }
} _msg_cpp_init;
...
int __cdecl msg_wait_resync() {
  ...
  v0 = UiProgressDialog(ghMainWnd, "Waiting for game data...", 1,
                        msg_wait_for_turns, 20);
  gbBufferMsgs = 0;
  if (!v0)
    goto LABEL_6;
  if (gbGameDestroyed) {
...
int __cdecl msg_wait_for_turns() {
  ...
  if (!sgbDeltaChunks) {
    ...
    if (!SNetGetOwnerTurnsWaiting(&turns) &&
        SErrGetLastError() == STORM_ERROR_NOT_IN_GAME)
      return 100;
    if (GetTickCount() - sgdwOwnerWait <= 2000 &&
        turns < (unsigned int)gdwTurnsInTransit)
      return 0;
    ++sgbDeltaChunks;
  }
    ...
    while (1) {
      ...
      if (v5->item[0].bCmd != -1) {
        ...
        if ((unsigned short)v5->item[0].wIndx == item[v1].IDidx &&
            ...
            v5->item[0].dwSeed == item[v7]._iSeed && (v6 == 1 || !v6)) {
          break;
        }
      }
      ++v3;
        ...
        do {
          if (sgLevels[currlevel].monster[v40]._mx != -1) {
            ...
            *v1 = v4;
            ...
            if (v5) {
              decode_enemy(
                  v0, *((unsigned char *)&sgLevels[0].monster[0]._menemy + v2));
              v7 = *(v1 - 3);
              if (v7 && v7 != 1 || *(v1 - 2))
    ...
    do {
      ...
      if (v10 != -1) {
        ...
        if (*(&sgLevels[0].item[0].bCmd + v13) == 2) {
          ...
          if (v16 == IDI_EAR) {
            RecreateEar(
                v14, *(short *)((char *)&sgLevels[0].item[0].wCI + v13),
            ...
            v20 = v14;
            item[v20]._iDurability =
                *((unsigned char *)&sgLevels[0].item[0].bDur + v19);
            item[v20]._iMaxDur =
                *((unsigned char *)&sgLevels[0].item[0].bMDur + v19);
...
void __fastcall NetSendCmdGItem(unsigned char bHiPri, unsigned char bCmd,
  ...
  if (v6) {
    ...
    cmd.dwSeed =
        item[v5]._iName[12] |
        ((item[v5]._iName[11] | ((v9 | (item[v5]._iName[9] << 8)) << 8)) << 8);
    ...
    cmd.wValue =
        _LOWORD(item[v5]._ivalue) | v8 | ((_LOWORD(item[v5]._iCurs) - 19) << 6);
    cmd.dwBuff =
        item[v5]._iName[22] |
        ((item[v5]._iName[21] | ((v10 | (item[v5]._iName[19] << 8)) << 8))
         << 8);
  } else {
...
void __fastcall NetSendCmdPItem(unsigned char bHiPri, unsigned char bCmd,
  ...
  if (v6) {
    ...
    cmd.dwSeed = plr[v4].HoldItem._iName[12] |
                 ((plr[v4].HoldItem._iName[11] |
                   ((v9 | (plr[v4].HoldItem._iName[9] << 8)) << 8))
                  << 8);
    ...
    cmd.wValue = _LOWORD(plr[v4].HoldItem._ivalue) | v8 |
                 ((_LOWORD(plr[v4].HoldItem._iCurs) - 19) << 6);
    cmd.dwBuff = plr[v4].HoldItem._iName[22] |
                 ((plr[v4].HoldItem._iName[21] |
                   ((v10 | (plr[v4].HoldItem._iName[19] << 8)) << 8))
                  << 8);
  } else {
...
void __fastcall NetSendCmdDItem(unsigned char bHiPri, int ii) {
  ...
  if (v4) {
    ...
    cmd.dwSeed =
        item[v2]._iName[12] |
        ((item[v2]._iName[11] | ((v7 | (item[v2]._iName[9] << 8)) << 8)) << 8);
    ...
    cmd.wValue =
        _LOWORD(item[v2]._ivalue) | v6 | ((_LOWORD(item[v2]._iCurs) - 19) << 6);
    cmd.dwBuff =
        item[v2]._iName[22] |
        ((item[v2]._iName[21] | ((v8 | (item[v2]._iName[19] << 8)) << 8)) << 8);
  } else {
  ...
  default:
    ...
    if ((unsigned char)gbDeltaSender == pnum) {
      if (sgbRecvCmd != CMD_DLEVEL_END) {
        ...
        LABEL_99:
          memcpy(&sgRecvBuf[*(unsigned short *)&v7[1].bCmd], &v7[5],
      ...
      if (v3->bCmd != CMD_DLEVEL_END &&
          (v3->bCmd != CMD_DLEVEL_0 || *(_WORD *)&v3[1].bCmd))
        goto LABEL_100;
      gbDeltaSender = pnum;
      sgbRecvCmd = CMD_DLEVEL_END;
    }
...
char __fastcall DeltaImportJunk(int a1) {
  ...
  do {
    if (*v1 == -1) {
      ...
      memcpy(v3, v1, 5u);
      v1 += 5;
      SetPortalStats(v2, 1, (unsigned char)v3->portal[0].x,
...
int __fastcall On_SBSPELL(struct TCmdParam1 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs != 1) {
    if (currlevel ||
        *(_DWORD *)&spelldata[(unsigned short)pCmd->wParam1].sTownSpell) {
      v2 = pnum;
      ...
      if (GetItemRecord(v2->dwSeed, v4, (unsigned short)v2->wIndx)) {
        ...
        if (v7 == -1) {
          ...
          if ((unsigned char)v2->bPnum == myplr)
            ...
            SyncGetItem((unsigned char)v2->x, (unsigned char)v2->y,
                        (unsigned short)v2->wIndx, v2->wCI, v2->dwSeed);
          _LOWORD(v9) = v2->wCI;
...
bool __fastcall i_own_level(int nReqLevel) {
  ...
  do {
    if (*(v2 - 290) && !*v2 && *(_DWORD *)(v2 - 267) == nReqLevel &&
        (v1 != myplr || !gbBufferMsgs))
      break;
    v2 += 21720;
    ++v1;
...
int __fastcall On_GETITEM(struct TCmdGItem *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    v6 = v2->bLevel;
    v7 = myplr;
    if ((currlevel == v6 || (unsigned char)v2->bPnum == myplr) &&
        (unsigned char)v2->bMaster != myplr) {
      if ((unsigned char)v2->bPnum != myplr) {
        SyncGetItem((unsigned char)v2->x, (unsigned char)v2->y,
                    (unsigned short)v2->wIndx, v2->wCI, v2->dwSeed);
        return 30;
      ...
      if (currlevel == v6) {
        ...
        _LOWORD(v8) = v2->wCI;
        v9 = SyncPutItem(myplr, plr[myplr].WorldX, plr[myplr].WorldY,
                         (unsigned short)v2->wIndx, v8, v2->dwSeed,
                         (unsigned char)v2->bId, (unsigned char)v2->bDur,
                         (unsigned char)v2->bMDur, (unsigned char)v2->bCh,
                         (unsigned char)v2->bMCh, (unsigned short)v2->wValue,
                         v2->dwBuff);
        if (v9 == -1)
          return 30;
        v7 = myplr;
...
bool __fastcall delta_get_item(struct TCmdGItem *pI, unsigned char bLevel) {
  ...
  if (gbMaxPlayers != 1) {
    ...
    v4 = &sgLevels[bLevel];
    v5 = &sgLevels[bLevel];
    while (v5->item[0].bCmd == -1 || v5->item[0].wIndx != v2->wIndx ||
           v5->item[0].wCI != v2->wCI || v5->item[0].dwSeed != v2->dwSeed) {
      ++v3;
      v5 = (DLevel *)((char *)v5 + 22);
      if (v3 >= 127)
        goto LABEL_15;
...
int __fastcall On_AGETITEM(struct TCmdGItem *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    v4 = v2->bLevel;
    v5 = myplr;
    if ((currlevel == v4 || (unsigned char)v2->bPnum == myplr) &&
        (unsigned char)v2->bMaster != myplr) {
      if ((unsigned char)v2->bPnum != myplr) {
        SyncGetItem((unsigned char)v2->x, (unsigned char)v2->y,
                    (unsigned short)v2->wIndx, v2->wCI, v2->dwSeed);
      ...
      if (currlevel == v4) {
        ...
        _LOWORD(v6) = v2->wCI;
        v7 = SyncPutItem(myplr, plr[myplr].WorldX, plr[myplr].WorldY,
                         (unsigned short)v2->wIndx, v6, v2->dwSeed,
                         (unsigned char)v2->bId, (unsigned char)v2->bDur,
                         (unsigned char)v2->bMDur, (unsigned char)v2->bCh,
                         (unsigned char)v2->bMCh, (unsigned short)v2->wValue,
                         v2->dwBuff);
...
int __fastcall On_ITEMEXTRA(struct TCmdGItem *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    if (currlevel == plr[v2].plrlevel)
      SyncGetItem((unsigned char)v3->x, (unsigned char)v3->y,
                  (unsigned short)v3->wIndx, v3->wCI, v3->dwSeed);
  }
  return 30;
}
// 676194: using guessed type char gbBufferMsgs;
...
int __fastcall On_PUTITEM(struct TCmdPItem *pCmd, int pnum) {
  ...
  if (v2 == myplr)
    ...
    v6 = SyncPutItem(v2, v5, (unsigned char)pCmd->y,
                     (unsigned short)pCmd->wIndx, (unsigned short)pCmd->wCI,
                     pCmd->dwSeed, (unsigned char)pCmd->bId,
                     (unsigned char)pCmd->bDur, (unsigned char)pCmd->bMDur,
                     (unsigned char)pCmd->bCh, (unsigned char)pCmd->bMCh,
                     (unsigned short)pCmd->wValue, pCmd->dwBuff);
  v8 = v6;
  if (v6 != -1) {
    _LOWORD(v7) = v3->wCI;
...
void __fastcall delta_put_item(struct TCmdPItem *pI, int x, int y,
  ...
  if (gbMaxPlayers != 1) {
    ...
    do {
      v8 = v7->item[0].bCmd;
      if (v7->item[0].bCmd != 1 && v8 != -1 && v7->item[0].wIndx == v4->wIndx &&
          v7->item[0].wCI == v4->wCI && v7->item[0].dwSeed == v4->dwSeed) {
        if (v8 == 2)
          return;
...
int __fastcall On_SYNCPUTITEM(struct TCmdPItem *pCmd, int pnum) {
  ...
  v6 = SyncPutItem(pnum, (unsigned char)pCmd->x, (unsigned char)pCmd->y,
                   (unsigned short)pCmd->wIndx, (unsigned short)pCmd->wCI,
                   pCmd->dwSeed, (unsigned char)pCmd->bId,
                   (unsigned char)pCmd->bDur, (unsigned char)pCmd->bMDur,
                   (unsigned char)pCmd->bCh, (unsigned char)pCmd->bMCh,
...
int __fastcall On_RESPAWNITEM(struct TCmdPItem *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    if (currlevel == *(_DWORD *)v3 && pnum != myplr)
      SyncPutItem(pnum, (unsigned char)pCmd->x, (unsigned char)pCmd->y,
                  (unsigned short)pCmd->wIndx, (unsigned short)pCmd->wCI,
                  pCmd->dwSeed, (unsigned char)pCmd->bId,
                  (unsigned char)pCmd->bDur, (unsigned char)pCmd->bMDur,
                  (unsigned char)pCmd->bCh, (unsigned char)pCmd->bMCh,
...
int __fastcall On_ATTACKID(struct TCmdParam1 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs != 1) {
    ...
    if (currlevel == plr[pnum].plrlevel) {
      ...
      if (v5 > 1 || v6 > 1)
        MakePlrPath(v2, monster[(unsigned short)v3->wParam1]._mfutx,
                    monster[(unsigned short)v3->wParam1]._mfuty, 0);
...
int __fastcall On_ATTACKPID(struct TCmdParam1 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs != 1) {
    v3 = pnum;
    if (currlevel == plr[pnum].plrlevel) {
      MakePlrPath(pnum, plr[(unsigned short)pCmd->wParam1]._px,
                  plr[(unsigned short)pCmd->wParam1]._py, 0);
...
int __fastcall On_NEWLVL(struct TCmdParam2 *pCmd, int pnum) {
  if (gbBufferMsgs == 1) {
    ...
    StartNewLvl(pnum, (unsigned short)pCmd->wParam1,
                (unsigned short)pCmd->wParam2);
  }
  return 5;
}
// 676194: using guessed type char gbBufferMsgs;
...
int __fastcall On_MONSTDEATH(struct TCmdLocParam1 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    if (currlevel == *(_DWORD *)v3)
      M_SyncStartKill((unsigned short)pCmd->wParam1, (unsigned char)pCmd->x,
                      (unsigned char)pCmd->y, pnum);
...
int __fastcall On_KILLGOLEM(struct TCmdLocParam1 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    if (currlevel == pCmd->wParam1)
      M_SyncStartKill(pnum, (unsigned char)pCmd->x, (unsigned char)pCmd->y,
                      pnum);
  ...
  if (gbBufferMsgs == 1) {
    ...
    if (currlevel == plr[pnum].plrlevel) {
      if (pnum != myplr) {
        ...
        if (v4)
        LABEL_16:
          AddMissile(*(int *)((char *)&plr[0].WorldX + v3),
                     *(int *)((char *)&plr[0].WorldY + v3),
                     (unsigned char)pCmd->_mx, (unsigned char)pCmd->_my,
                     (unsigned char)pCmd->_mdir, MIS_GOLEM, 0, v2, 0, 1);
      }
    } else {
      ...
      if (*v6) {
        *v6 -= (unsigned short)v3->wParam1;
        ...
        if ((signed int)(*v7 & 0xFFFFFFC0) < 64)
          *v7 = 64;
        delta_monster_hp(*(unsigned short *)&v3->x,
                         monster[*(unsigned short *)&v3->x]._mhitpoints, *v4);
      }
    }
  }
  return 5;
...
int __fastcall On_PLROPOBJ(struct TCmdParam2 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    v3 = (unsigned char *)&plr[pnum].plrlevel;
    if (currlevel == *(_DWORD *)v3)
      SyncOpObject((unsigned short)pCmd->wParam1, CMD_PLROPOBJ,
                   (unsigned short)pCmd->wParam2);
...
int __fastcall On_BREAKOBJ(struct TCmdParam2 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    v3 = (unsigned char *)&plr[pnum].plrlevel;
    if (currlevel == *(_DWORD *)v3)
      SyncBreakObj((unsigned short)pCmd->wParam1,
                   (unsigned short)pCmd->wParam2);
...
int __fastcall On_CHANGEPLRITEMS(struct TCmdChItem *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    CheckInvSwap(v2, v5, (unsigned short)pCmd->wIndx, v4, pCmd->dwSeed,
...
int __fastcall On_DROPITEM(struct TCmdPItem *pCmd, int pnum) {
  if (gbBufferMsgs == 1)
    ...
    delta_put_item(pCmd, (unsigned char)pCmd->x, (unsigned char)pCmd->y,
                   plr[pnum].plrlevel);
  return 22;
}
// 676194: using guessed type char gbBufferMsgs;
...
int __fastcall On_PLAYER_JOINLEVEL(struct TCmdLocParam1 *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    if (plr[pnum]._pName[0] && !plr[v4].plractive) {
      plr[v4].plractive = 1;
      ++gbActivePlayers;
      EventPlrMsg("Player '%s' (level %d) just joined the game",
                  plr[pnum]._pName, plr[v4]._pLevel);
    }
    if (plr[v4].plractive) {
      if (myplr != v2) {
        ...
        if (currlevel == plr[v4].plrlevel) {
          ...
          v11 = AddVision(plr[v4].WorldX, plr[v4].WorldY, plr[v4]._pLightRad,
                          v2 == myplr);
          plr[v4]._plid = -1;
          plr[v4]._pvid = v11;
        }
...
int __fastcall On_ACTIVATEPORTAL(DJunk *pCmd, int pnum) {
  ...
  if (gbBufferMsgs == 1) {
    ...
    ActivatePortal(pnum, (unsigned char)pCmd->portal[0].y,
    ...
    if (v3 != myplr) {
      if (currlevel) {
        if (currlevel == plr[v3].plrlevel) {
          ...
          if (v2)
          LABEL_19:
            AddWarpMissile(v3, (unsigned char)v4->portal[0].y,
                           (unsigned char)v4->portal[0].level);
        } else {
...
int __fastcall On_SYNCQUEST(struct TCmdQuest *pCmd, int pnum) {
  if (gbBufferMsgs == 1) {
    ...
    if (pnum != myplr)
      SetMultiQuest((unsigned char)pCmd->q, (unsigned char)pCmd->qstate,
                    pCmd->qlog, (unsigned char)pCmd->qvar1);
    sgbDeltaChanged = 1;
  }
  return 5;
}
...
int __fastcall On_ENDSHIELD(int a1, int pnum) {
  ...
  if (gbBufferMsgs != 1 && pnum != myplr && currlevel == plr[pnum].plrlevel) {
    for (i = 0; i < nummissiles; ++i) {
      v4 = missileactive[i];
      v5 = missileactive[i];
      if (missile[v5]._mitype == MIS_MANASHIELD &&
