...
int sgdwCursWdt;
int(__fastcall *DrawPlrProc)(int player_num, int x, int y, int screen_x,
                             int screen_y, void *cl2_buf, int frame,
                             int frame_width, int a9, int a10);
...
struct scrollrt_cpp_init {
  scrollrt_cpp_init() { scrollrt_cpp_init_value = scrollrt_inf; }
} _scrollrt_cpp_init;
...
//----- (00452994) --------------------------------------------------------
void __fastcall DrawMissile(int x, int y, int sx, int sy, int a5, int a6,
                            int del_flag) {
  int v7;             // ebx
  char v8;            // al
  int v9;             // eax
  ...
  if (v8 == -1) {
    ...
    for (i = 0; i < nummissiles; v9 = i++ + 1) {
      ...
      if (v10 >= 125)
        break;
      v11 = &missile[v10];
      if (v11->_mix == v26 && v11->_miy == v7 && v11->_miPreFlag == del_flag &&
          v11->_miDrawFlag) {
        ...
        if (v11->_miUniqTrans) {
          Cl2DecodeFrm3(v15, v14, v12, v13, v11->_miAnimWidth, a5, a6,
                        _LOBYTE(v11->_miUniqTrans) + 3);
          v7 = v25;
        } else {
      ...
      if (v16->_miDrawFlag) {
        ...
        if (v17) {
          ...
          if (v18 >= 1 && (unsigned int)*v17 <= 0x32 && v18 <= *v17) {
            ...
            if (v16->_miUniqTrans) {
              Cl2DecodeFrm3(v20, v19, v17, v18, v16->_miAnimWidth, a5, a6,
                            LOBYTE(v16->_miUniqTrans) + 3);
            } else {
...
//----- (00452B2A) --------------------------------------------------------
void __fastcall DrawClippedMissile(int x, int y, int sx, int sy, int a5, int a6,
                                   int a7) {
  int v7;             // ebx
  char v8;            // al
  int v9;             // eax
  ...
  if (v8 == -1) {
    ...
    for (i = 0; i < nummissiles; v9 = i++ + 1) {
      ...
      if (v10 >= 125)
        break;
      v11 = &missile[v10];
      if (v11->_mix == v26 && v11->_miy == v7 && v11->_miPreFlag == a7 &&
          v11->_miDrawFlag) {
        v12 = (char *)v11->_miAnimData;
        if (!v12)
          return;
        ...
        v15 = sx + v11->_mixoff - v11->_miAnimWidth2;
        if (v11->_miUniqTrans) {
          Cl2DecodeFrm5(v15, v14, v12, v13, v11->_miAnimWidth, a5, a6,
                        _LOBYTE(v11->_miUniqTrans) + 3);
          v7 = v25;
        } else {
          v23 = v11->_miAnimWidth;
      ...
      if (v16->_miDrawFlag) {
        ...
        if (v17) {
          ...
          if (v18 >= 1 && (unsigned int)*v17 <= 0x32 && v18 <= *v17) {
            ...
            v20 = sx + v16->_mixoff - v16->_miAnimWidth2;
            if (v16->_miUniqTrans) {
              Cl2DecodeFrm5(v20, v19, v17, v18, v16->_miAnimWidth, a5, a6,
                            LOBYTE(v16->_miUniqTrans) + 3);
            } else {
              v24 = v16->_miAnimWidth;
              v22 = v16->_miAnimFrame;
...
//----- (00452CC0) --------------------------------------------------------
void __fastcall DrawDeadPlayer(int x, int y, int sx, int sy, int a5, int a6,
                               bool clipped) {
  int v7;         // ebx
  int *v8;        // esi
  char *v9;       // edi
  ...
  v7 = y;
  xa = x;
  DrawPlrProc = (int(__fastcall *)(int, int, int, int, int, void *, int, int,
                                   int, int))DrawClippedPlayer;
  if (!clipped)
    DrawPlrProc = (int(__fastcall *)(int, int, int, int, int, void *, int, int,
                                     int, int))DrawPlayer;
  ...
  *v9 &= 0xFBu;
  player_num = 0;
  do {
    if (!*((_BYTE *)v8 - 379) || *v8 || *(v8 - 89) != currlevel ||
        *(v8 - 88) != xa || *(v8 - 87) != v7)
      goto LABEL_14;
    v10 = (int *)*(v8 - 71);
    if (!v10)
    ...
    if (v11 < 1 || (unsigned int)*v10 > 0x32 || v11 > *v10)
      break;
    *v9 |= 4u;
    DrawPlrProc(player_num, xa, v7, sx + *(v8 - 78) - *(v8 - 65),
                sy + *(v8 - 77), v10, v11, *(v8 - 66), a5, a6);
  LABEL_14:
    ++player_num;
    v8 += 5430;
...
//----- (00452DA0) --------------------------------------------------------
void __fastcall DrawPlayer(int pnum, int x, int y, int px, int py, int animdata,
                           int animframe, int animwidth, int a9, int a10) {
  char *v10;     // edx
  int v11;       // eax
  char *v12;     // ecx
  ...
  if (*v10 & 0x40 || plr[myplr]._pInfraFlag || !setlevel && !currlevel) {
    v12 = (char *)animdata;
    if (animdata) {
      if (animframe >= 1 && *(_DWORD *)animdata <= 0x32u &&
          animframe <= *(_DWORD *)animdata) {
        if (v13 == pcursplr) {
          Cl2DecodeFrm2(165, px, py, (char *)animdata, animframe, animwidth, a9,
                        a10);
          v11 = myplr;
          v12 = (char *)animdata;
          v10 = (char *)ya;
        ...
        if (v13 == v11) {
          ...
          if (plr[v13].pManaShield)
            Cl2DecodeFrm1(px + plr[v13]._pAnimWidth2 -
                              misfiledata[9].mAnimWidth2[0],
                          py, (char *)misfiledata[9].mAnimData[0], 1,
                          misfiledata[9].mAnimWidth[0], a9, a10);
        } else if (!(*v10 & 0x40) ||
                   plr[v11]._pInfraFlag && light_table_index > 8) {
          Cl2DecodeFrm3(px, py, v12, animframe, animwidth, a9, a10, 1);
          if (plr[v13].pManaShield)
            Cl2DecodeFrm3(px + plr[v13]._pAnimWidth2 -
                              misfiledata[9].mAnimWidth2[0],
                          py, (char *)misfiledata[9].mAnimData[0], 1,
                          misfiledata[9].mAnimWidth[0], a9, a10, 1);
        } else {
          ...
          if (plr[v13].pManaShield)
            Cl2DecodeLightTbl(px + plr[v13]._pAnimWidth2 -
                                  misfiledata[9].mAnimWidth2[0],
                              py, (char *)misfiledata[9].mAnimData[0], 1,
                              misfiledata[9].mAnimWidth[0], a9, a10);
...
//----- (00452F8B) --------------------------------------------------------
void __fastcall DrawClippedPlayer(int pnum, int x, int y, int px, int py,
                                  int animdata, int animframe, int animwidth,
                                  int a9, int a10) {
  char *v10;     // edx
  int v11;       // eax
  char *v12;     // ecx
  ...
  if (*v10 & 0x40 || plr[myplr]._pInfraFlag) {
    ...
    if (animdata) {
      if (animframe >= 1 && *(_DWORD *)animdata <= 0x32u &&
          animframe <= *(_DWORD *)animdata) {
        if (v13 == pcursplr) {
          Cl2DecodeClrHL(165, px, py, (char *)animdata, animframe, animwidth,
                         a9, a10);
          v11 = myplr;
          v12 = (char *)animdata;
          v10 = (char *)ya;
        ...
        if (v13 == v11) {
          ...
          if (plr[v13].pManaShield)
            Cl2DecodeFrm4(px + plr[v13]._pAnimWidth2 -
                              misfiledata[9].mAnimWidth2[0],
                          py, (char *)misfiledata[9].mAnimData[0], 1,
                          misfiledata[9].mAnimWidth[0], a9, a10);
        } else if (!(*v10 & 0x40) ||
          ...
          if (plr[v13].pManaShield)
            Cl2DecodeFrm5(px + plr[v13]._pAnimWidth2 -
                              misfiledata[9].mAnimWidth2[0],
                          py, (char *)misfiledata[9].mAnimData[0], 1,
                          misfiledata[9].mAnimWidth[0], a9, a10, 1);
        } else {
          ...
          if (plr[v13].pManaShield)
            Cl2DecodeFrm6(px + plr[v13]._pAnimWidth2 -
                              misfiledata[9].mAnimWidth2[0],
                          py, (char *)misfiledata[9].mAnimData[0], 1,
                          misfiledata[9].mAnimWidth[0], a9, a10);
          light_table_index = animdataa;
...
//----- (00453477) --------------------------------------------------------
void __fastcall scrollrt_draw_lower(int x, int y, int sx, int sy, int a5,
                                    int some_flag) {
  unsigned int v6;    // edi
  unsigned int v7;    // ebx
  ...
  v8 = (unsigned short *)((char *)dpiece_defs_map_1 +
                          32 * gendung_get_dpiece_num_from_coord(x, y));
  if (some_flag) {
    if (v6 < 0x70 && v7 < 0x70) {
      v9 = v7;
      ...
      if (v10) {
        ...
        v21 = sy;
        scrollrt_draw_clipped_dungeon((char *)gpBuffer +
                                          screen_y_times_768[sy] + sx,
                                      sxa, sya, sx, sy, 0);
        goto LABEL_21;
      }
...
LABEL_23:
    ...
    do {
      ...
      if (sya < 112 && v22 >= 0) {
        ...
        if (v24) {
          ...
          scrollrt_draw_clipped_dungeon((char *)gpBuffer + *v25 + sx, sxa, sya,
                                        sx, sy, 1);
          v21 = sy;
        } else {
          world_draw_black_tile((char *)gpBuffer + screen_y_times_768[v21] +
                                sx);
        }
        v22 = v47;
      }
  ...
  if (some_flag && (unsigned int)sya < 0x70 && sxa < 0x70) {
    ...
    if (v34) {
      ...
      scrollrt_draw_clipped_dungeon((char *)gpBuffer + *v51 + sx, sxa, sya, sx,
                                    sy, 0);
    } else {
...
//----- (004538E2) --------------------------------------------------------
void __fastcall scrollrt_draw_clipped_dungeon(char *a1, int sx, int sy, int a4,
                                              int a5, int a6) {
  int v6;             // eax
  char v7;            // bl
  char v8;            // cl
    ...
    if (!v16->_iPostDraw && (unsigned char)v49 <= 0x7Fu) {
      ...
      if (v17) {
        ...
        if (v18 >= 1 && *(_DWORD *)v17 <= 0x32u && v18 <= *(_DWORD *)v17) {
          ...
          if (v49 - 1 == pcursitem)
            CelDrawHdrClrHL(181, v19, a5, v17, v16->_iAnimFrame,
                            v16->_iAnimWidth, 0, 8);
          Cel2DecodeHdrLight(v19, a5, (char *)v16->_iAnimData, v16->_iAnimFrame,
                             v16->_iAnimWidth, 0, 8);
        }
      }
    }
  ...
  if (v50 & 0x20) {
    ...
    if (v20 < 4) {
      v21 = &plr[v20];
      DrawClippedPlayer(v20, a1a, sy - 1, a4 + v21->_pxoff - v21->_pAnimWidth2,
                        a5 + v21->_pyoff, v21->_pAnimData, v21->_pAnimFrame,
                        v21->_pAnimWidth, 0, 8);
      if (a6) {
        v22 = v21->_peflag;
        if (v22) {
          if (v22 == 2)
            scrollrt_draw_clipped_e_flag(dst_buf - 12384, a1a - 2, sy + 1,
                                         a4 - 96, a5 - 16);
          scrollrt_draw_clipped_e_flag(dst_buf - 64, a1a - 1, sy + 1, a4 - 64,
                                       a5);
        }
      }
    }
    ...
    if ((unsigned int)(-1 - v41) < 0xC8) {
      ...
      if (!(v24->_mFlags & 1)) {
        ...
        if (v25) {
          ...
          if (v23 == pcursmonst) {
            Cl2DecodeClrHL(233, v27, v26, (char *)v24->_mAFNum,
                           v24->_mAnimFrame, v25->flags_1, 0, 8);
  ...
  if (v48 > 0) {
    ...
    if (v28 < 4) {
      v29 = &plr[v28];
      DrawClippedPlayer(v28, a1a, sy, a4 + v29->_pxoff - v29->_pAnimWidth2,
                        a5 + v29->_pyoff, v29->_pAnimData, v29->_pAnimFrame,
                        v29->_pAnimWidth, 0, 8);
      if (a6) {
        v30 = v29->_peflag;
        if (v30) {
    ...
    if ((unsigned int)(v40 - 1) < 0xC8) {
      ...
      if (!(v32->_mFlags & 1)) {
        ...
        if (v33) {
          ...
          if (v31 == pcursmonst) {
            Cl2DecodeClrHL(233, v35, v34, (char *)v32->_mAFNum,
                           v32->_mAnimFrame, v33->flags_1, 0, 8);
      ...
      if ((unsigned char)v49 <= 0x7Fu) {
        ...
        if (v37) {
          ...
          if (v38 >= 1 && *(_DWORD *)v37 <= 0x32u && v38 <= *(_DWORD *)v37) {
            ...
            if (v49 - 1 == pcursitem)
              CelDrawHdrClrHL(181, v39, a5, v37, v36->_iAnimFrame,
                              v36->_iAnimWidth, 0, 8);
            Cel2DecodeHdrLight(v39, a5, (char *)v36->_iAnimData,
                               v36->_iAnimFrame, v36->_iAnimWidth, 0, 8);
          }
        }
      }
    }
...
//----- (00453ED9) --------------------------------------------------------
void __fastcall DrawClippedMonster(int x, int y, int a3, int a4, int mon_id,
                                   int a6, int a7) {
  int v7;        // eax
  char *v8;      // esi
  signed int v9; // ebx
...
//----- (00453FCC) --------------------------------------------------------
void __fastcall DrawClippedObject(int x, int y, int a3, int a4, int pre_flag,
                                  int a6, int dir) {
  int v7;           // edi
  char v8;          // al
  unsigned char v9; // dl
  ...
  if (v9 < 0x7Fu) {
    ...
    if (v15) {
      ...
      if (v16 >= 1 && *(_DWORD *)v15 <= 0x32u && v16 <= *(_DWORD *)v15) {
        if (v20 == pcursobj)
          CelDrawHdrClrHL(194, v12, v11, v15, v16, object[v10]._oAnimWidth, a6,
                          dir);
...
//----- (004540E5) --------------------------------------------------------
void __fastcall scrollrt_draw_clipped_e_flag(char *buffer, int x, int y, int a4,
                                             int a5) {
  int v5;              // eax
  int v6;              // ebx
  int v7;              // ecx
...
//----- (00454229) --------------------------------------------------------
void __fastcall scrollrt_draw_lower_2(int x, int y, int sx, int sy, int a5,
                                      int a6, int some_flag) {
  signed int v7;       // ebx
  int v8;              // edi
  int v9;              // ecx
  int v10;             // eax
    ...
    if (v7 >= 0 && v7 < 112 && xa >= 0 && xa < 112) {
      ...
      if (v10) {
        ...
        cel_transparency_active =
            (unsigned char)(nTransTable[v10] & TransList[dung_map[0][v9]]);
        ...
        if (v12 < 8)
          scrollrt_draw_clipped_dungeon_2(
              (char *)gpBuffer + screen_y_times_768[sy] - 12288 * v12 + v8, xa,
              v7, a6, 2 * a6 + 2, v8, sy, 0);
      }
    }
    ++xa;
    --v7;
    ...
    do {
      ...
      if (v7 < 112 && v13 >= 0) {
        ...
        if (v15) {
          a6b = 0;
          cel_transparency_active =
              (unsigned char)(nTransTable[v15] & TransList[dung_map[0][v14]]);
          ...
          if (2 * a6 + 2 < 8)
            scrollrt_draw_clipped_dungeon_2((char *)gpBuffer +
                                                screen_y_times_768[sy] -
                                                ((3 * a6 + 3) << 13) + v8,
                                            xa, a1, a6, 2 * a6 + 2, v8, sy, 1);
          v7 = a1;
        }
      }
      ++xa;
  ...
  if (some_flag) {
    if ((unsigned int)v7 < 0x70 && (unsigned int)xa < 0x70) {
      ...
      if (v20) {
        a6c = 0;
        cel_transparency_active =
            (unsigned char)(nTransTable[v20] & TransList[dung_map[0][v19]]);
        ...
        if (v22 < 8)
          scrollrt_draw_clipped_dungeon_2(
              (char *)gpBuffer + screen_y_times_768[sy] - 12288 * v22 + v8, xa,
              v7, a6, 2 * a6 + 2, v8, sy, 0);
      }
    }
  }
...
//----- (004545D2) --------------------------------------------------------
void __fastcall scrollrt_draw_clipped_dungeon_2(char *buffer, int x, int y,
                                                int a4, int a5, int sx, int sy,
                                                int me_flag) {
  int v8;             // eax
  char v9;            // bl
  char v10;           // cl
    ...
    if (!v19->_iPostDraw && (unsigned char)v52 <= 0x7Fu) {
      ...
      if (v20) {
        ...
        if (v21 >= 1 && *(_DWORD *)v20 <= 0x32u && v21 <= *(_DWORD *)v20) {
          ...
          if (v52 - 1 == pcursitem)
            CelDrawHdrClrHL(181, v22, sy, v20, v19->_iAnimFrame,
                            v19->_iAnimWidth, a5, 8);
          Cel2DecodeHdrLight(v22, sy, (char *)v19->_iAnimData, v19->_iAnimFrame,
                             v19->_iAnimWidth, a5, 8);
        }
      }
    }
  ...
  if (v53 & 0x20) {
    ...
    if (v23 < 4) {
      v24 = &plr[v23];
      DrawClippedPlayer(v23, a1, y - 1, v13 + v24->_pxoff - v24->_pAnimWidth2,
                        sy + v24->_pyoff, v24->_pAnimData, v24->_pAnimFrame,
                        v24->_pAnimWidth, a5, 8);
      if (me_flag) {
        v25 = v24->_peflag;
        if (v25) {
          if (v25 == 2)
            scrollrt_draw_clipped_e_flag_2(dst_buf - 12384, a1 - 2, y + 1, a4,
                                           a5, v13 - 96, sy - 16);
          scrollrt_draw_clipped_e_flag_2(dst_buf - 64, a1 - 1, y + 1, a4, a5,
                                         v13 - 64, sy);
        }
      }
    }
    ...
    if ((unsigned int)(-1 - v44) < 0xC8) {
      ...
      if (!(v27->_mFlags & 1)) {
        ...
        if (v28) {
          ...
          if (v26 == pcursmonst) {
            Cl2DecodeClrHL(233, v30, v29, (char *)v27->_mAFNum,
                           v27->_mAnimFrame, v28->flags_1, a5, 8);
  ...
  if (v51 > 0) {
    ...
    if (v31 < 4) {
      v32 = &plr[v31];
      DrawClippedPlayer(v31, a1, y, v13 + v32->_pxoff - v32->_pAnimWidth2,
                        sy + v32->_pyoff, v32->_pAnimData, v32->_pAnimFrame,
                        v32->_pAnimWidth, a5, 8);
      if (me_flag) {
        v33 = v32->_peflag;
        if (v33) {
          if (v33 == 2)
    ...
    if ((unsigned int)(v43 - 1) < 0xC8) {
      ...
      if (!(v35->_mFlags & 1)) {
        ...
        if (v36) {
          ...
          if (v34 == pcursmonst) {
            Cl2DecodeClrHL(233, v38, v37, (char *)v35->_mAFNum,
                           v35->_mAnimFrame, v36->flags_1, a5, 8);
      ...
      if ((unsigned char)v52 <= 0x7Fu) {
        ...
        if (v40) {
          ...
          if (v41 >= 1 && *(_DWORD *)v40 <= 0x32u && v41 <= *(_DWORD *)v40) {
            ...
            Cel2DecodeHdrLight(v42, sy, (char *)v39->_iAnimData,
                               v39->_iAnimFrame, v39->_iAnimWidth, a5, 8);
          }
        }
      }
    }
...
//----- (00454C09) --------------------------------------------------------
void __fastcall scrollrt_draw_clipped_e_flag_2(char *buffer, int x, int y,
                                               int a4, signed int a5, int sx,
                                               int sy) {
  int v7;              // eax
  int v8;              // ecx
  int v9;              // esi
  ...
  v13 = (unsigned short *)((char *)dpiece_defs_map_1 +
                           32 * gendung_get_dpiece_num_from_coord(x, y));
  if (!a4) {
    v14 = v13[2];
...
//----- (00454D9D) --------------------------------------------------------
void __fastcall scrollrt_draw_upper(int x, int y, int sx, int sy, int a5,
                                    int a6, int some_flag) {
  int v7;             // edi
  int v8;             // esi
  ...
  ya = y;
  xa = x;
  v9 = (unsigned short *)((char *)dpiece_defs_map_1 +
                          32 * gendung_get_dpiece_num_from_coord(x, y));
  a5a = 2 * a6 + 2;
  if (a5a > 8)
    a5a = 8;
  if (some_flag) {
    if (v7 >= 0 && v7 < 112 && v8 >= 0 && v8 < 112) {
      ...
      if (v11) {
        cel_transparency_active =
            (unsigned char)(nTransTable[v11] & TransList[dung_map[0][v10]]);
        ...
        v7 = ya;
        scrollrt_draw_dungeon((char *)gpBuffer + screen_y_times_768[sy] + sx,
                              xa, ya, a6, a5a, sx, sy, 0);
      } else {
        world_draw_black_tile((char *)gpBuffer + screen_y_times_768[sy] + sx);
      }
    }
  ...
  if (some_flag && v7 >= 0 && v7 < 112 && xa >= 0 && xa < 112) {
    ...
    if (v32) {
      arch_draw_type = 1;
      cel_transparency_active =
          (unsigned char)(nTransTable[v32] & TransList[dung_map[0][v31]]);
      ...
      scrollrt_draw_dungeon((char *)gpBuffer + screen_y_times_768[sy] + sx, xa,
                            ya, a6, a5a, sx, sy, 0);
    } else {
      world_draw_black_tile((char *)gpBuffer + screen_y_times_768[sy] + sx);
    }
...
//----- (00455217) --------------------------------------------------------
void __fastcall scrollrt_draw_dungeon(char *buffer, int x, int y, int a4,
                                      int a5, int sx, int sy, int me_flag) {
  int v8;             // eax
  char v9;            // bl
  char v10;           // cl
  char v11;           // dl
    ...
    if (!v18->_iPostDraw && (unsigned char)v51 <= 0x7Fu) {
      ...
      if (v19) {
        ...
        if (v20 >= 1 && *(_DWORD *)v19 <= 0x32u && v20 <= *(_DWORD *)v19) {
          ...
          if (v51 - 1 == pcursitem)
            CelDecodeClr(181, v21, sy, v19, v18->_iAnimFrame, v18->_iAnimWidth,
                         0, a5);
          CelDecodeHdrLightOnly(v21, sy, (char *)v18->_iAnimData,
                                v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);
        }
      }
    }
  }
  if (v52 & 0x20) {
    ...
    if (v22 < 4) {
      v23 = &plr[v22];
      DrawPlayer(v22, xa, y - 1, sx + v23->_pxoff - v23->_pAnimWidth2,
                 sy + v23->_pyoff, v23->_pAnimData, v23->_pAnimFrame,
                 v23->_pAnimWidth, 0, a5);
      if (me_flag) {
        v24 = v23->_peflag;
        if (v24) {
          if (v24 == 2)
            scrollrt_draw_e_flag(dst_buf - 12384, xa - 2, y + 1, a4, a5,
                                 sx - 96, sy - 16);
          scrollrt_draw_e_flag(dst_buf - 64, xa - 1, y + 1, a4, a5, sx - 64,
                               sy);
        }
      }
    }
    ...
    if ((unsigned int)(-1 - v43) < 0xC8) {
      ...
      if (!(v26->_mFlags & 1)) {
        ...
        if (v27) {
          ...
          if (v25 == pcursmonst) {
            Cl2DecodeFrm2(233, v29, v28, (char *)v26->_mAFNum, v26->_mAnimFrame,
                          v27->flags_1, 0, a5);
  ...
  if (v50 > 0) {
    ...
    if (v30 < 4) {
      v31 = &plr[v30];
      DrawPlayer(v30, xa, y, sx + v31->_pxoff - v31->_pAnimWidth2,
                 sy + v31->_pyoff, v31->_pAnimData, v31->_pAnimFrame,
                 v31->_pAnimWidth, 0, a5);
      if (me_flag) {
        v32 = v31->_peflag;
        if (v32) {
          if (v32 == 2)
    ...
    if ((unsigned int)(v42 - 1) < 0xC8) {
      ...
      if (!(v34->_mFlags & 1)) {
        ...
        if (v35) {
          ...
          if (v33 == pcursmonst) {
            Cl2DecodeFrm2(233, v37, v36, (char *)v34->_mAFNum, v34->_mAnimFrame,
                          v35->flags_1, 0, a5);
      ...
      if ((unsigned char)v51 <= 0x7Fu) {
        ...
        if (v39) {
          ...
          if (v40 >= 1 && *(_DWORD *)v39 <= 0x32u && v40 <= *(_DWORD *)v39) {
            ...
            if (v51 - 1 == pcursitem)
              CelDecodeClr(181, v41, sy, v39, v38->_iAnimFrame,
                           v38->_iAnimWidth, 0, a5);
            CelDecodeHdrLightOnly(v41, sy, (char *)v38->_iAnimData,
                                  v38->_iAnimFrame, v38->_iAnimWidth, 0, a5);
          }
        }
      }
    }
...
//----- (00455844) --------------------------------------------------------
void __fastcall DrawMonster(int x, int y, int a3, int a4, int mon_id, int a6,
                            int a7) {
  int v7;        // eax
  char *v8;      // esi
  signed int v9; // ebx
...
//----- (00455937) --------------------------------------------------------
void __fastcall DrawObject(int x, int y, int a3, int a4, int pre_flag, int a6,
                           int dir) {
  int v7;           // edi
  char v8;          // al
  unsigned char v9; // dl
  ...
  if (v9 < 0x7Fu) {
    ...
    if (v15) {
      ...
      if (v16 >= 1 && *(_DWORD *)v15 <= 0x32u && v16 <= *(_DWORD *)v15) {
        if (v18 == pcursobj)
          CelDecodeClr(194, v12, v11, v15, v16, object[v10]._oAnimWidth, a6,
                       dir);
        if (object[v10]._oLight) {
          CelDecodeHdrLightOnly(v12, v11, (char *)object[v10]._oAnimData,
                                object[v10]._oAnimFrame,
                                object[v10]._oAnimWidth, a6, dir);
        } else {
          v17 = (char *)object[v10]._oAnimData;
          if (v17)
            CelDrawHdrOnly(v12, v11, v17, object[v10]._oAnimFrame,
                           object[v10]._oAnimWidth, a6, dir);
        }
      }
    }
...
//----- (00455A7D) --------------------------------------------------------
void __fastcall scrollrt_draw_e_flag(char *buffer, int x, int y, int a4, int a5,
                                     int sx, int sy) {
  int v7;              // eax
  char *v8;            // esi
  int v9;              // ecx
  ...
  if (pcurs > 0) {
    ...
    if (cursW) {
      ...
      if (cursH) {
        ...
        if (pcurs < 12) {
          Cel2DrawHdrOnly(v9 + 64, v1 + v10 + 159, (char *)pCursCels, pcurs, v0,
                          0, 8);
        } else {
          v11 = 197;
          ...
          if (!plr[myplr].HoldItem._iStatFlag)
            v11 = 229;
          v12 = v9 + 64;
          CelDrawHdrClrHL(v11, v12, v1 + v10 + 159, (char *)pCursCels, pcurs,
                          v0, 0, 8);
          v13 = cursH + v10 + 159;
          if (v11 == 229)
            Cel2DrawHdrLightRed(v12, v13, (char *)pCursCels, pcurs, cursW, 0, 8,
                                1);
          else
...
//----- (00456124) --------------------------------------------------------
void __fastcall DrawMain(int dwHgt, int draw_desc, int draw_hp, int draw_mana,
                         int draw_sbar, int draw_btn) {
  signed int v6; // ebp
  DWORD v7;      // ebx
  int v8;        // esi
  int v9;        // eax
  ...
  if (window_activated && lpDDSPrimary) {
    ...
    LABEL_8:
      ...
      while (1) {
        DDS_desc.dwSize = 108;
        v8 = lpDDSPrimary->Lock(NULL, &DDS_desc, DDLOCK_WRITEONLY | DDLOCK_WAIT,
                                NULL);
        if (!v8)
          break;
        ...
        LABEL_17:
          if (v8 != DDERR_SURFACELOST && v8 != DDERR_WASSTILLDRAWING &&
              v8 != DDERR_SURFACEBUSY) {
    ...
    if (a4 < 480) {
      ...
      if (sgdwCursWdtOld)
        DoBlitScreen(sgdwCursXOld, sgdwCursYOld, sgdwCursWdtOld,
                     sgdwCursHgtOld);
      if (sgdwCursWdt)
...
void __fastcall DoBlitScreen(int dwX, int dwY, int dwWdt, int dwHgt) {
  ...
  if (lpDDSBackBuf) {
    ...
    while (1) {
      error_code =
          lpDDSPrimary->BltFast(v5, v4, lpDDSBackBuf, &Rect, DDBLTFAST_WAIT);
      if (!error_code)
        break;
      if (a4 - GetTickCount() <= 5000) {
        ...
        if (error_code == DDERR_SURFACELOST)
          return;
        if (error_code == DDERR_WASSTILLDRAWING ||
            error_code == DDERR_SURFACEBUSY)
          continue;
      }
      if (error_code != DDERR_SURFACELOST &&
          error_code != DDERR_WASSTILLDRAWING &&
          error_code != DDERR_SURFACEBUSY)
...
void __cdecl DrawAndBlit() {
  ...
  if (gbRunGame) {
    ...
    scrollrt_draw_cursor_item();
    dx_unlock_mutex();
    DrawMain(dwHgt, ddsdesc, drawhpflag, drawmanaflag, drawsbarflag,
             drawbtnflag);
    dx_lock_mutex();
    scrollrt_draw_cursor_back_buffer();
    dx_unlock_mutex();
